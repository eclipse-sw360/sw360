...
@org.osgi.service.component.annotations.Component(immediate = true, properties = {
		...
		"/org/eclipse/sw360/portal/portlets/admin.properties"}, property = {
				...
				"javax.portlet.display-name=Fossology Administration", "javax.portlet.info.short-title=Fossology",
				"javax.portlet.info.title=Fossology Administration", "javax.portlet.resource-bundle=content.Language",
				"javax.portlet.init-param.view-template=/html/admin/fossyAdmin/view.jsp",}, service = Portlet.class, configurationPolicy = ConfigurationPolicy.REQUIRE)
