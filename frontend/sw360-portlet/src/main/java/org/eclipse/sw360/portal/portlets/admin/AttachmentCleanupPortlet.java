...
@org.osgi.service.component.annotations.Component(immediate = true, properties = {
		...
		"/org/eclipse/sw360/portal/portlets/admin.properties"}, property = {
				...
				"javax.portlet.display-name=Attachment Cleanup", "javax.portlet.info.short-title=Attachment Cleanup",
				"javax.portlet.info.title=Attachment Cleanup", "javax.portlet.resource-bundle=content.Language",
				"javax.portlet.init-param.view-template=/html/admin/attachmentCleanup/view.jsp",}, service = Portlet.class, configurationPolicy = ConfigurationPolicy.REQUIRE)
public class AttachmentCleanupPortlet extends Sw360Portlet {

	private static final Logger log = LogManager.getLogger(AttachmentCleanupPortlet.class);
