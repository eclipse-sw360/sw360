...
public class UserPortletUtils {
	...
	public static User addLiferayUser(HttpServletRequest request, String firstName, String lastName,
		...
		return addLiferayUser(requestAdapter, firstName, lastName, emailAddress, organizationName, roleName, male,
				externalId, password, passwordEncrypted, activateImmediately);
	}

	public static User addLiferayUser(PortletRequest request, String firstName, String lastName, String emailAddress,
			String organizationName, String roleName, boolean male, String externalId, String password,
			boolean passwordEncrypted, boolean activateImmediately) throws SystemException, PortalException {
	...
	private static User addLiferayUser(RequestAdapter requestAdapter, String firstName, String lastName,
		...
		try {
			...
			User user = UserLocalServiceUtil.addUser(defaultUser.getUserId()/* creator */, companyId, false, /*
																												 * autoPassword
																												 */
					password, password, false, /* autoScreenName */
					externalId, emailAddress, 0/* facebookId */, externalId/* openId */, defaultUser.getLocale(),
					firstName, ""/* middleName */, lastName, 0/* prefixId */, 0/* suffixId */, male,
					4/* birthdayMonth */, 12/* birthdayDay */, 1959/* birthdayYear */, ""/* jobTitle */,
					null/* groupIds */, organizationIds, roleIds, userGroupIds, false/* sendEmail */, serviceContext);
			...
			User updatedUser = UserLocalServiceUtil.updateStatus(user.getUserId(),
	...
	private static boolean userAlreadyExists(Consumer<String> errorMessageConsumer, String emailAddress,
			String externalId, long companyId) throws PortalException, SystemException {
		boolean sameEmailExists = userByFieldExists(emailAddress, UserLocalServiceUtil::getUserByEmailAddress,
				companyId);
		boolean sameExternalIdExists = userByFieldExists(externalId, UserLocalServiceUtil::getUserByScreenName,
				companyId);
	...
	private static boolean userByFieldExists(String searchParameter, UserSearchFunction searchFunction, long companyId)
