...
@org.osgi.service.component.annotations.Component(immediate = true, properties = {
		...
		"/org/eclipse/sw360/portal/portlets/user.properties"}, property = {
				...
				"javax.portlet.display-name=My Projects", "javax.portlet.info.short-title=My Projects",
				"javax.portlet.info.title=My Projects", "javax.portlet.resource-bundle=content.Language",
				"javax.portlet.init-param.view-template=/html/homepage/myprojects/view.jsp",}, service = Portlet.class, configurationPolicy = ConfigurationPolicy.REQUIRE)
public class MyProjectsPortlet extends Sw360Portlet {
	...
	private static final ImmutableList<String> listOfClearingState = ImmutableList.of(
			ProjectClearingState.OPEN.toString(), ProjectClearingState.CLOSED.toString(),
			ProjectClearingState.IN_PROGRESS.toString());
