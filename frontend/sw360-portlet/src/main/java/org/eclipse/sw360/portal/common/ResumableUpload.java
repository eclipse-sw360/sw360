...
class ResumableUpload {
	...
	private ResumableUpload(String attachmentId, int chunkNumber, int chunkSize, int totalChunks, String filename,
			String fileType) {
	...
	public static ResumableUpload from(ResourceRequest request) {
		...
		return new ResumableUpload(attachmentId, resumableChunkNumber, resumableChunkSize, resumableTotalChunks,
				resumableFilename, fileType);
	}
