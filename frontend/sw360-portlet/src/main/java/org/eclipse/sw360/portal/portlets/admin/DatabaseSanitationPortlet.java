...
@org.osgi.service.component.annotations.Component(immediate = true, properties = {
		...
		"/org/eclipse/sw360/portal/portlets/admin.properties"}, property = {
				...
				"javax.portlet.display-name=Database Sanitation", "javax.portlet.info.short-title=Database Sanitation",
				"javax.portlet.info.title=Database Sanitation", "javax.portlet.resource-bundle=content.Language",
				"javax.portlet.init-param.view-template=/html/admin/databaseSanitation/view.jsp",}, service = Portlet.class, configurationPolicy = ConfigurationPolicy.REQUIRE)
public class DatabaseSanitationPortlet extends Sw360Portlet {
	...
	private void serveDuplicates(ResourceRequest request, ResourceResponse response)
		...
		if (oneIsNull(duplicateComponents, duplicateReleases, duplicateProjects, duplicateReleaseSources)) {
			...
			include("/html/admin/databaseSanitation/duplicatesAjax.jsp", request, response,
