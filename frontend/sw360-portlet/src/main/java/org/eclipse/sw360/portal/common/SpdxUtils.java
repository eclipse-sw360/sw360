...
public abstract class SpdxUtils {

    private SpdxUtils() {
        // Utility class with only static functions
    }

    private static final Logger log = LogManager.getLogger(SpdxUtils.class);
    ...
    public static void updateSPDX(ActionRequest request, ActionResponse response, User user, String releaseId, Set<String> moderators, boolean addNew) throws TException {
