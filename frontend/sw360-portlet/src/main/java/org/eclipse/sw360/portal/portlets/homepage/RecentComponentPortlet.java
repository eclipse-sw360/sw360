...
@org.osgi.service.component.annotations.Component(immediate = true, properties = {
		...
		"/org/eclipse/sw360/portal/portlets/user.properties"}, property = {
				...
				"javax.portlet.display-name=Recent Components", "javax.portlet.info.short-title=Recent Components",
				"javax.portlet.info.title=Recent Components", "javax.portlet.resource-bundle=content.Language",
				"javax.portlet.init-param.view-template=/html/homepage/recentcomponents/view.jsp",}, service = Portlet.class, configurationPolicy = ConfigurationPolicy.REQUIRE)
