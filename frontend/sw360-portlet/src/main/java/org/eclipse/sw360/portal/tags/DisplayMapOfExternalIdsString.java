...
public class DisplayMapOfExternalIdsString extends SimpleTagSupport {
	...
	private static String getExternalIdsString(String externalIdKey, String externalIdValues) {
		...
		nullToEmptySet(externalIdValueSet).forEach(e -> sb.append("<li><span class=\"mapDisplayChildItemLeft\">")
				.append(StringEscapeUtils.escapeXml(externalIdKey))
				.append("</span><span class=\"mapDisplayChildItemRight\"> ").append(StringEscapeUtils.escapeXml(e))
				.append("</span></li>"));
		return sb.toString();
	}
}
