...
public class DisplayMapOfSecondaryGroupAndRoles extends SimpleTagSupport {
	...
	private static String getGroupAndRolesString(String group, Set<UserGroup> roles) {
		...
		sb.append("<li><span class=\"mapDisplayChildItemLeft\">").append(StringEscapeUtils.escapeXml(group))
				.append("</span><span> -> </span><span class=\"mapDisplayChildItemRight\"> ").append(rolesSb.toString())
				.append("</span></li>");
		return sb.toString();
	}
}
