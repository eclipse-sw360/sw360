...
public class DisplayStateBoxes extends SimpleTagSupport {
	...
	public String makeBoxes() {
		...
		String box_PS = "<div class=\"stateBox " + projectStateBackgroundColour
				+ " capsuleLeft \" title=\"Project state: " + ThriftEnumUtils.enumToString(project.state)
				+ "\"> PS </div>";
		String box_CS = "<div class=\"stateBox capsuleRight " + clearingStateBackgroundColour
				+ "\" title=\"Project clearing state: " + ThriftEnumUtils.enumToString(project.clearingState)
				+ "\"> CS </div>";
