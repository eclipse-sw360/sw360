...
public class PaginationParameters {
	...
	public PaginationParameters(String echo, String columnNames, int displayLength, int displayStart, int columnCount,
			Optional<Integer> sortingColumn, Optional<Boolean> ascending) {
		this.echo = echo;
