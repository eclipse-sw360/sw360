...
<jsp:useBean id="actual_DocumentCreationInfo" class="org.eclipse.sw360.datahandler.thrift.spdx.documentcreationinformation.DocumentCreationInformation" scope="request" />
<jsp:useBean id="defaultLicenseInfoHeaderText" class="java.lang.String" scope="request" />

<core_rt:set var="spdxDocumentCreationInfo" value="${actual_DocumentCreationInfo}" scope="request"/>

<div class="container" id="moderation-request-merge" data-document-type="<%=DocumentType.SPDX_DOCUMENT_CREATION_INFO%>">

    <core_rt:set var="moderationTitle" value="Change ${sw360:printDocumentCreationInfoName(spdxDocumentCreationInfo)}" scope="request" />
                    ...
                    <div class="card">
                        ...
                        <div id="moderation-changes" class="collapse" aria-labelledby="moderation-changes-heading" data-parent="#moderation-wizard">
                            <div class="card-body">
                                ...
                                <sw360:DisplayDocumentCreationInfoChanges
                                    actual="${actual_DocumentCreationInfo}"
                                    additions="${moderationRequest.documentCreationInfoAdditions}"
                                    deletions="${moderationRequest.documentCreationInfoDeletions}"
