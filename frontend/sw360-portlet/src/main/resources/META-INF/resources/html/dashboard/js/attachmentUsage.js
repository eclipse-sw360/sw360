...
define(['d3'], function(d3) {
	...
	// Parse the Data 
	d3.csv(contextPathUrl + '/html/dashboard/data/attachmentUsage.csv').then( function(data) {
	...
	var Tooltip4 = d3.select("#CLISizeViz")
	.append("div")
	.style("opacity", 0)
