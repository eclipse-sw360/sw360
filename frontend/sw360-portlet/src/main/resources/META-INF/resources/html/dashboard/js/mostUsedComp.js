...
define(['d3'], function(d3) {
	...
	var svg5 = d3.select("#mostUsedCompViz")
	  .append("svg")
	...
	//Read the data
	d3.csv(contextPathUrl + '/html/dashboard/data/mostUsedComp.csv').then( function(csvData) {
	  ...
	  const tooltip5 = d3.select("#mostUsedCompViz")
	    .append("div")
	      .style("opacity", 0)
