...
<div class="container" id="moderation-request-merge" data-document-type="<%=DocumentType.SPDX_PACKAGE_INFO%>">
    ...
    <core_rt:set var="moderationTitle" value="Delete ${sw360:printPackageInfoName(packageInfo)}" scope="request" />
                    ...
                    <div class="card">
                        ...
                        <div id="moderation-changes" class="collapse p-3" aria-labelledby="moderation-changes-heading" data-parent="#moderation-wizard">
                            <div class="alert alert-danger mb-0">
                                The SPDX Document <sw360:out value='${sw360:printPackageInfoName(packageInfo)}'/> is requested to be deleted.
                            </div>
                        </div>
                    </div>
                </core_rt:if>
