...
<portlet:renderURL var="viewDashboardURL">
    <portlet:param name="<%=PortalConstants.PAGENAME%>" value="<%=PortalConstants.PAGENAME_DASHBOARD%>"/>
</portlet:renderURL>

<!DOCTYPE html>
<head>
  <meta charset="utf-8">
  <title>SW360 SI Dashboard</title>
...
<script type="text/javascript">
    ...
    console.log(componentTypeSI);
    if (componentTypeSI && componentTypeSI.drawComponentTypeChart) {
        google.charts.load('current', { packages: ['corechart'] });
        google.charts.setOnLoadCallback(componentTypeSI.drawComponentTypeChart);
        google.charts.setOnLoadCallback(mostUsedLicenseSI.drawmostUsedLicense);
        google.charts.setOnLoadCallback(releaseStatusBasedonTypeSI.init);
        
        var typeFilterSelect = document.getElementById('typeFilter');
        if (typeFilterSelect) {
            typeFilterSelect.onchange = releaseStatusBasedonTypeSI.updateChart;
        }
    } else {
...
<script type="text/javascript">
                    ...
                    <div class="col-auto">
                        <div class="btn-toolbar" role="toolbar">
                            <div class="btn-group" role="group">
                                <a class ="dash-link" href="<%=viewDashboardURL%>">Global Dashboard</a> <!--<%=request.getContextPath()%>/html/dashboard/view.jsp"-->
                            </div>
                        </div>
                    </div>
                 </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="chart-container" id="timeSeriesVizSI">
                <select class = "dash-select" id="selectButton"></select>
            </div>
            <div class="chart-container" id="componentTypeVizSI"></div>
        </div>
        <br><br>
        <div id="dash-div-header">
        ...
        <div class="row">
            <div class="chart-container" id="mostUsedCompVizSI">
            </div>
        ...
        <div class="row">
            <div class="chart-container" id="mostUsedLicenseVizSI"></div>
            <div id="table-container">
