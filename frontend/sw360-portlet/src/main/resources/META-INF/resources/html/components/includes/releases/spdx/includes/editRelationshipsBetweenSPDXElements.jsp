            ...
            <td>
                <div class="form-group">
                    ...
                    <div style="display: flex">
                        <input style="margin-right: 1rem;" id="spdxElement" class="form-control" name="_sw360_portlet_components_LICENSE_ID" type="text" placeholder="Enter SPDX Element" value="">
                        <input style="margin-right: 1rem;" id="relationshipType" class="form-control" name="_sw360_portlet_components_LICENSE_ID" type="text" placeholder="Enter Relationship Type" value="">
                        <input id="relatedSPDXElement" class="form-control" name="_sw360_portlet_components_LICENSE_ID" type="text" placeholder="Enter Related SPDX Element" value="">
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="relationshipComment" rows="5" name="_sw360_portlet_components_RELATIONSHIP_COMMENT" placeholder="Enter License Comment"></textarea>
                </div>
            </td>
        </tr>
    </tbody>
