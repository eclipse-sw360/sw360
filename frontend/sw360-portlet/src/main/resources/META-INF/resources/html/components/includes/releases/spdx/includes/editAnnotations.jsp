            ...
            <td style="display: flex">
                <div class="form-group" style="flex: 3">
                    ...
                    <div style="display: flex">
                        <select id="annotatorType" style="flex: 2; margin-right: 1rem;" type="text" class="form-control" placeholder="Enter Type" value="">
                            <option value="Organization" selected>Organization</option>
                            <option value="Person">Person</option>
                            <option value="Tool">Tool</option>
                        </select>
                        <input style="flex: 6; margin-right: 1rem;" id="annotatorValue" type="text" class="form-control" placeholder="Enter Value" value="">
                    </div>
                </div>
                <div class="form-group" style="flex: 1">
                    ...
                    <div style="display: flex">
                        <input id="annotationCreatedDate" style="width: 12rem; text-align: center;" type="date" class="form-control" name="_sw360_portlet_components_SPDX_CREATED_DATE" placeholder="creation.date.yyyy.mm.dd" value="">
                        <input id="annotationCreatedTime" style="width: 12rem; text-align: center; margin-left: 10px;" type="time" step="1" class="form-control" name="_sw360_portlet_components_SPDX_CREATED_TIME" placeholder="creation.time.hh.mm.ss" value="">
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td style="display: flex">
                <div class="form-group" style="flex: 1">
                    ...
                    <input id="annotationType" class="form-control needs-validation" name="_sw360_portlet_components_ANNOTATION_TYPE" type="text" placeholder="Enter Annotation Type" value="">
                </div>
                <div class="form-group" style="flex: 1">
                    <label class="mandatory" for="spdxIdRef">
                        8.4 SPDX Identifier Reference
                    </label>
                    <input id="spdxIdRef" class="form-control needs-validation" name="_sw360_portlet_components_SPDX_IDENTIFIER_REF" type="text" placeholder="Enter SPDX Identifier Reference" value="">
                </div>
            </td>
        </tr>
		<tr>
            <td>
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="annotationComment" rows="5" name="_sw360_portlet_components_ANNOTATION_COMMENT" placeholder="Enter License Comment"></textarea>
		        </div>
		    </td>
		</tr>
	</tbody>
    ...
    <core_rt:if test="${not annotations.isEmpty()}">
        ...
        <core_rt:forEach items="${annotations}" var="annotationsData" varStatus="loop">
            ...
            if (i == index) {
                ...
                setCreatedTime("${annotationsData.annotationDate}");
