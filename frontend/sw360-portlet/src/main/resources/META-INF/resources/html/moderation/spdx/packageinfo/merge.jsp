...
<jsp:useBean id="actual_PackageInfo" class="org.eclipse.sw360.datahandler.thrift.spdx.spdxpackageinfo.PackageInformation" scope="request" />
<jsp:useBean id="defaultLicenseInfoHeaderText" class="java.lang.String" scope="request" />

<core_rt:set var="packageInfo" value="${actual_PackageInfo}" scope="request"/>

<div class="container" id="moderation-request-merge" data-document-type="<%=DocumentType.SPDX_PACKAGE_INFO%>">

    <core_rt:set var="moderationTitle" value="Change ${sw360:printPackageInfoName(packageInfo)}" scope="request" />
                    ...
                    <div class="card">
                        ...
                        <div id="moderation-changes" class="collapse" aria-labelledby="moderation-changes-heading" data-parent="#moderation-wizard">
                            <div class="card-body">
                                ...
                                <sw360:DisplayPackageInfoChanges
                                    actual="${actual_PackageInfo}"
                                    additions="${moderationRequest.packageInfoAdditions}"
                                    deletions="${moderationRequest.packageInfoDeletions}"
