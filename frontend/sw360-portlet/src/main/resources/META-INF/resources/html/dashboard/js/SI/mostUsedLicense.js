...
function drawmostUsedLicense() {
    fetch(contextPathUrl + '/html/dashboard/data/SI/mostUsedLicenses.csv')
    ...
    var chart = new google.visualization.PieChart(document.getElementById('mostUsedLicenseVizSI'));
