...
define(['d3'], function(d3) {
  function init() {
    ...
    d3.csv(contextPathUrl + '/html/dashboard/data/releaseStatusBasedOnCompType.csv').then(function(data) {
  ...
  function drawChart(data) {
    ...
    var chart = new google.visualization.PieChart(document.getElementById('releaseStatusViz'));
