...
class OptionalSetDefaultTest;

class OptionalBinary;
...
class Bools : public virtual ::apache::thrift::TBase {
 public:
  ...
  Bools(const Bools&) noexcept;
  Bools& operator=(const Bools&) noexcept;
  Bools() noexcept
        : im_true(0),
          im_false(0) {
  }

  virtual ~Bools() noexcept;
  bool im_true;
  bool im_false;
...
class CrazyNesting : public virtual ::apache::thrift::TBase {
 public:
  ...
  CrazyNesting() noexcept
               : string_field(),
                 binary_field() {
  }

  virtual ~CrazyNesting() noexcept;
...
class EmptyStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  EmptyStruct(const EmptyStruct&) noexcept;
  EmptyStruct& operator=(const EmptyStruct&) noexcept;
  EmptyStruct() noexcept {
  }

  virtual ~EmptyStruct() noexcept;
...
class OneField : public virtual ::apache::thrift::TBase {
 public:
  ...
  OneField(const OneField&) noexcept;
  OneField& operator=(const OneField&) noexcept;
  OneField() noexcept {
  }

  virtual ~OneField() noexcept;
  EmptyStruct field;
...
class VersioningTestV1 : public virtual ::apache::thrift::TBase {
 public:
  ...
  VersioningTestV1() noexcept
                   : begin_in_both(0),
                     old_string(),
                     end_in_both(0) {
  }

  virtual ~VersioningTestV1() noexcept;
...
class VersioningTestV2 : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~VersioningTestV2() noexcept;
  int32_t begin_in_both;
  int32_t newint;
  int8_t newbyte;
  int16_t newshort;
...
class ListTypeVersioningV1 : public virtual ::apache::thrift::TBase {
 public:
  ...
  ListTypeVersioningV1() noexcept
                       : hello() {
  }

  virtual ~ListTypeVersioningV1() noexcept;
...
class ListTypeVersioningV2 : public virtual ::apache::thrift::TBase {
 public:
  ...
  ListTypeVersioningV2() noexcept
                       : hello() {
  }

  virtual ~ListTypeVersioningV2() noexcept;
...
class GuessProtocolStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  GuessProtocolStruct() noexcept {
  }

  virtual ~GuessProtocolStruct() noexcept;
...
class LargeDeltas : public virtual ::apache::thrift::TBase {
 public:
  ...
  LargeDeltas() noexcept
              : check_true(0),
                check_false(0) {
  }

  virtual ~LargeDeltas() noexcept;
  Bools b1;
  Bools b10;
  Bools b100;
  bool check_true;
...
class NestedListsI32x2 : public virtual ::apache::thrift::TBase {
 public:
  ...
  NestedListsI32x2() noexcept {
  }

  virtual ~NestedListsI32x2() noexcept;
...
class NestedListsI32x3 : public virtual ::apache::thrift::TBase {
 public:
  ...
  NestedListsI32x3() noexcept {
  }

  virtual ~NestedListsI32x3() noexcept;
...
class NestedMixedx2 : public virtual ::apache::thrift::TBase {
 public:
  ...
  NestedMixedx2() noexcept {
  }

  virtual ~NestedMixedx2() noexcept;
...
class NestedListsBonk : public virtual ::apache::thrift::TBase {
 public:
  ...
  NestedListsBonk() noexcept {
  }

  virtual ~NestedListsBonk() noexcept;
...
typedef struct _OptionalSetDefaultTest__isset {
  _OptionalSetDefaultTest__isset() : with_default(true) {}
  bool with_default :1;
} _OptionalSetDefaultTest__isset;

class OptionalSetDefaultTest : public virtual ::apache::thrift::TBase {
 public:

  OptionalSetDefaultTest(const OptionalSetDefaultTest&);
  OptionalSetDefaultTest& operator=(const OptionalSetDefaultTest&);
  OptionalSetDefaultTest() noexcept {
    with_default.insert("test");

  }

  virtual ~OptionalSetDefaultTest() noexcept;
  std::set<std::string>  with_default;

  _OptionalSetDefaultTest__isset __isset;

  void __set_with_default(const std::set<std::string> & val);

  bool operator == (const OptionalSetDefaultTest & rhs) const
  {
    if (__isset.with_default != rhs.__isset.with_default)
      return false;
    else if (__isset.with_default && !(with_default == rhs.with_default))
      return false;
    return true;
  }
  bool operator != (const OptionalSetDefaultTest &rhs) const {
  ...
  bool operator < (const OptionalSetDefaultTest & ) const;
...
typedef struct _OptionalBinary__isset {
  _OptionalBinary__isset() : bin_set(true), bin_map(true) {}
  bool bin_set :1;
  bool bin_map :1;
} _OptionalBinary__isset;

class OptionalBinary : public virtual ::apache::thrift::TBase {
 public:

  OptionalBinary(const OptionalBinary&);
  OptionalBinary& operator=(const OptionalBinary&);
  OptionalBinary() noexcept {


  }

  virtual ~OptionalBinary() noexcept;
  std::set<std::string>  bin_set;
  std::map<std::string, int32_t>  bin_map;

  _OptionalBinary__isset __isset;

  void __set_bin_set(const std::set<std::string> & val);

  void __set_bin_map(const std::map<std::string, int32_t> & val);

  bool operator == (const OptionalBinary & rhs) const
  {
    if (__isset.bin_set != rhs.__isset.bin_set)
      return false;
    else if (__isset.bin_set && !(bin_set == rhs.bin_set))
      return false;
    if (__isset.bin_map != rhs.__isset.bin_map)
      return false;
    else if (__isset.bin_map && !(bin_map == rhs.bin_map))
      return false;
    return true;
  }
  bool operator != (const OptionalBinary &rhs) const {
  ...
  bool operator < (const OptionalBinary & ) const;
