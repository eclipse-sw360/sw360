...
const std::map<int, const char*> _MyEnum1_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(6, _kMyEnum1Values, _kMyEnum1Names), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const MyEnum1::type& val) {
  std::map<int, const char*>::const_iterator it = _MyEnum1_VALUES_TO_NAMES.find(val);
  if (it != _MyEnum1_VALUES_TO_NAMES.end()) {
...
const std::map<int, const char*> _MyEnum2_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kMyEnum2Values, _kMyEnum2Names), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const MyEnum2::type& val) {
  std::map<int, const char*>::const_iterator it = _MyEnum2_VALUES_TO_NAMES.find(val);
  if (it != _MyEnum2_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _MyEnum2_again_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kMyEnum2_againValues, _kMyEnum2_againNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const MyEnum2_again::type& val) {
  std::map<int, const char*>::const_iterator it = _MyEnum2_again_VALUES_TO_NAMES.find(val);
  if (it != _MyEnum2_again_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _MyEnum3_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(8, _kMyEnum3Values, _kMyEnum3Names), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const MyEnum3::type& val) {
  std::map<int, const char*>::const_iterator it = _MyEnum3_VALUES_TO_NAMES.find(val);
  if (it != _MyEnum3_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _MyEnum4_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kMyEnum4Values, _kMyEnum4Names), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const MyEnum4::type& val) {
  std::map<int, const char*>::const_iterator it = _MyEnum4_VALUES_TO_NAMES.find(val);
  if (it != _MyEnum4_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _MyEnum5_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kMyEnum5Values, _kMyEnum5Names), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const MyEnum5::type& val) {
  std::map<int, const char*>::const_iterator it = _MyEnum5_VALUES_TO_NAMES.find(val);
  if (it != _MyEnum5_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _MyEnumWithCustomOstream_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kMyEnumWithCustomOstreamValues, _kMyEnumWithCustomOstreamNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->me2_2 = static_cast<MyEnum2::type>(ecast0);
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->me3_n2 = static_cast<MyEnum3::type>(ecast1);
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->me3_d1 = static_cast<MyEnum3::type>(ecast2);
...
uint32_t MyStruct::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->me2_2));
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("me3_n2", ::apache::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32(static_cast<int32_t>(this->me3_n2));
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("me3_d1", ::apache::thrift::protocol::T_I32, 3);
  xfer += oprot->writeI32(static_cast<int32_t>(this->me3_d1));
  xfer += oprot->writeFieldEnd();
...
MyStruct::MyStruct(const MyStruct& other3) noexcept {
  me2_2 = other3.me2_2;
  me3_n2 = other3.me3_n2;
  me3_d1 = other3.me3_d1;
  __isset = other3.__isset;
}
MyStruct& MyStruct::operator=(const MyStruct& other4) noexcept {
  me2_2 = other4.me2_2;
...
EnumTestStruct::~EnumTestStruct() noexcept {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->a_enum = static_cast<MyEnum3::type>(ecast5);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            for (_i10 = 0; _i10 < _size6; ++_i10)
            {
              ...
              this->enum_list[_i10] = static_cast<MyEnum3::type>(ecast11);
            }
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            for (_i16 = 0; _i16 < _size12; ++_i16)
            {
              ...
              _elem17 = static_cast<MyEnum3::type>(ecast18);
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i23 = 0; _i23 < _size19; ++_i23)
            {
              ...
              _key24 = static_cast<MyEnum3::type>(ecast26);
              MyEnum3::type& _val25 = this->enum_enum_map[_key24];
              int32_t ecast27;
              xfer += iprot->readI32(ecast27);
              _val25 = static_cast<MyEnum3::type>(ecast27);
            }
            ...
            for (_i32 = 0; _i32 < _size28; ++_i32)
            {
              std::vector<MyEnum3::type>  _key33;
              {
                ...
                for (_i39 = 0; _i39 < _size35; ++_i39)
                {
                  ...
                  _key33[_i39] = static_cast<MyEnum3::type>(ecast40);
                }
                xfer += iprot->readListEnd();
              }
              ...
              _val34 = static_cast<MyEnum3::type>(ecast41);
            }
            xfer += iprot->readMapEnd();
          }
            ...
            for (_i46 = 0; _i46 < _size42; ++_i46)
            {
              std::set<MyEnum3::type>  _key47;
              {
                ...
                for (_i53 = 0; _i53 < _size49; ++_i53)
                {
                  ...
                  _elem54 = static_cast<MyEnum3::type>(ecast55);
              ...
              _val48 = static_cast<MyEnum3::type>(ecast56);
            }
            xfer += iprot->readMapEnd();
          }
            ...
            for (_i61 = 0; _i61 < _size57; ++_i61)
            {
              std::map<MyEnum3::type, MyEnum3::type>  _key62;
              {
                ...
                for (_i68 = 0; _i68 < _size64; ++_i68)
                {
                  ...
                  _key69 = static_cast<MyEnum3::type>(ecast71);
                  MyEnum3::type& _val70 = _key62[_key69];
                  int32_t ecast72;
                  xfer += iprot->readI32(ecast72);
                  _val70 = static_cast<MyEnum3::type>(ecast72);
                }
                xfer += iprot->readMapEnd();
              }
              ...
              _val63 = static_cast<MyEnum3::type>(ecast73);
            }
            xfer += iprot->readMapEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i78 = 0; _i78 < _size74; ++_i78)
            {
              ...
              _key79 = static_cast<MyEnum3::type>(ecast81);
              std::map<MyEnum3::type, MyEnum3::type> & _val80 = this->enum_map_map[_key79];
              {
                ...
                for (_i86 = 0; _i86 < _size82; ++_i86)
                {
                  ...
                  _key87 = static_cast<MyEnum3::type>(ecast89);
                  MyEnum3::type& _val88 = _val80[_key87];
                  int32_t ecast90;
                  xfer += iprot->readI32(ecast90);
                  _val88 = static_cast<MyEnum3::type>(ecast90);
                }
                xfer += iprot->readMapEnd();
              }
            }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i95 = 0; _i95 < _size91; ++_i95)
            {
              ...
              _key96 = static_cast<MyEnum3::type>(ecast98);
              std::set<MyEnum3::type> & _val97 = this->enum_set_map[_key96];
              {
                ...
                for (_i103 = 0; _i103 < _size99; ++_i103)
                {
                  ...
                  _elem104 = static_cast<MyEnum3::type>(ecast105);
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i110 = 0; _i110 < _size106; ++_i110)
            {
              ...
              _key111 = static_cast<MyEnum3::type>(ecast113);
              std::vector<MyEnum3::type> & _val112 = this->enum_list_map[_key111];
              {
                ...
                for (_i118 = 0; _i118 < _size114; ++_i118)
                {
                  ...
                  _val112[_i118] = static_cast<MyEnum3::type>(ecast119);
                }
                xfer += iprot->readListEnd();
              }
            }
...
uint32_t EnumTestStruct::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->a_enum));
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("enum_set", ::apache::thrift::protocol::T_SET, 3);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>((*_iter121)));
    }
  ...
  xfer += oprot->writeFieldBegin("enum_enum_map", ::apache::thrift::protocol::T_MAP, 4);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>(_iter122->first));
      xfer += oprot->writeI32(static_cast<int32_t>(_iter122->second));
    }
    ...
    {
      {
        ...
        {
          xfer += oprot->writeI32(static_cast<int32_t>((*_iter124)));
        }
        xfer += oprot->writeListEnd();
      }
      xfer += oprot->writeI32(static_cast<int32_t>(_iter123->second));
    }
    xfer += oprot->writeMapEnd();
  }
  xfer += oprot->writeFieldEnd();
    ...
    {
      {
        ...
        {
          xfer += oprot->writeI32(static_cast<int32_t>((*_iter126)));
        }
        xfer += oprot->writeSetEnd();
      }
      xfer += oprot->writeI32(static_cast<int32_t>(_iter125->second));
    }
    xfer += oprot->writeMapEnd();
  }
  xfer += oprot->writeFieldEnd();
    ...
    {
      {
        ...
        {
          xfer += oprot->writeI32(static_cast<int32_t>(_iter128->first));
          xfer += oprot->writeI32(static_cast<int32_t>(_iter128->second));
        }
        xfer += oprot->writeMapEnd();
      }
      xfer += oprot->writeI32(static_cast<int32_t>(_iter127->second));
    }
    xfer += oprot->writeMapEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("enum_map_map", ::apache::thrift::protocol::T_MAP, 47);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>(_iter129->first));
      {
        ...
        {
          xfer += oprot->writeI32(static_cast<int32_t>(_iter130->first));
          xfer += oprot->writeI32(static_cast<int32_t>(_iter130->second));
        }
        xfer += oprot->writeMapEnd();
      }
    }
  ...
  xfer += oprot->writeFieldBegin("enum_set_map", ::apache::thrift::protocol::T_MAP, 48);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>(_iter131->first));
      {
        ...
        {
          xfer += oprot->writeI32(static_cast<int32_t>((*_iter132)));
        }
        xfer += oprot->writeSetEnd();
      }
    }
  ...
  xfer += oprot->writeFieldBegin("enum_list_map", ::apache::thrift::protocol::T_MAP, 49);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>(_iter133->first));
      {
        ...
        {
          xfer += oprot->writeI32(static_cast<int32_t>((*_iter134)));
        }
        xfer += oprot->writeListEnd();
      }
    }
