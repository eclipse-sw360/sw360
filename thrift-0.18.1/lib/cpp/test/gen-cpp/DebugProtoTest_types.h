...
class MutableException;

class ExceptionWithoutFields;
...
class Doubles : public virtual ::apache::thrift::TBase {
 public:
  ...
  Doubles(const Doubles&) noexcept;
  Doubles& operator=(const Doubles&) noexcept;
  Doubles() noexcept
          : nan(0),
            inf(0),
            neginf(0),
...
class Backwards : public virtual ::apache::thrift::TBase {
 public:
  ...
  Backwards(const Backwards&) noexcept;
  Backwards& operator=(const Backwards&) noexcept;
  Backwards() noexcept
            : first_tag2(0),
              second_tag1(0) {
  }

  virtual ~Backwards() noexcept;
  int32_t first_tag2;
  int32_t second_tag1;
...
class CompactProtoTestStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  CompactProtoTestStruct() noexcept
                         : a_byte(0),
                           a_i16(0),
                           a_i32(0),
                           a_i64(0),
  ...
  virtual ~CompactProtoTestStruct() noexcept;
  int8_t a_byte;
  int16_t a_i16;
  int32_t a_i32;
  int64_t a_i64;
  ...
  void __set_field500(const int64_t val);

  void __set_field5000(const int64_t val);

  void __set_field20000(const int64_t val);
  ...
  bool operator == (const CompactProtoTestStruct & rhs) const
  {
    ...
    if (!(byte_list_map == rhs.byte_list_map))
      return false;
    if (!(field500 == rhs.field500))
      return false;
    if (!(field5000 == rhs.field5000))
      return false;
    if (!(field20000 == rhs.field20000))
      return false;
    return true;
  }
  bool operator != (const CompactProtoTestStruct &rhs) const {
...
class SingleMapTestStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  SingleMapTestStruct() noexcept {
  }

  virtual ~SingleMapTestStruct() noexcept;
...
class ExceptionWithAMap : public ::apache::thrift::TException {
 public:
  ...
  ExceptionWithAMap() noexcept
                    : blah() {
  }

  virtual ~ExceptionWithAMap() noexcept;
  std::string blah;
...
typedef struct _MutableException__isset {
  _MutableException__isset() : msg(false) {}
  bool msg :1;
} _MutableException__isset;

class MutableException : public ::apache::thrift::TException {
 public:

  MutableException(const MutableException&);
  MutableException& operator=(const MutableException&);
  MutableException() noexcept
                   : msg() {
  }

  virtual ~MutableException() noexcept;
  std::string msg;

  _MutableException__isset __isset;

  void __set_msg(const std::string& val);

  bool operator == (const MutableException & rhs) const
  {
    if (!(msg == rhs.msg))
      return false;
    return true;
  ...
  bool operator < (const MutableException & ) const;
...
class ExceptionWithoutFields : public ::apache::thrift::TException {
 public:

  ExceptionWithoutFields(const ExceptionWithoutFields&) noexcept;
  ExceptionWithoutFields& operator=(const ExceptionWithoutFields&) noexcept;
  ExceptionWithoutFields() noexcept {
  }

  virtual ~ExceptionWithoutFields() noexcept;

  bool operator == (const ExceptionWithoutFields & /* rhs */) const
  {
    return true;
  }
  bool operator != (const ExceptionWithoutFields &rhs) const {
  ...
  bool operator < (const ExceptionWithoutFields & ) const;
...
class ReverseOrderStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ReverseOrderStruct() noexcept;
  std::string first;
  int16_t second;
  int32_t third;
  int64_t fourth;
...
class StructWithSomeEnum : public virtual ::apache::thrift::TBase {
 public:
  ...
  StructWithSomeEnum(const StructWithSomeEnum&) noexcept;
  StructWithSomeEnum& operator=(const StructWithSomeEnum&) noexcept;
  StructWithSomeEnum() noexcept
                     : blah(static_cast<SomeEnum::type>(0)) {
  }

  virtual ~StructWithSomeEnum() noexcept;
  /**
   * 
   * @see SomeEnum
   */
 ...
 public:
  ...
  TestUnion() noexcept
            : string_field(),
              i32_field(0),
              other_i32_field(0),
              enum_field(static_cast<SomeEnum::type>(0)) {
  }

  virtual ~TestUnion() noexcept;
  /**
   * A doc string
   */
...
class TestUnionMinusStringField : public virtual ::apache::thrift::TBase {
 public:
  ...
  TestUnionMinusStringField() noexcept
                            : i32_field(0),
                              other_i32_field(0),
                              enum_field(static_cast<SomeEnum::type>(0)) {
  }

  virtual ~TestUnionMinusStringField() noexcept;
  int32_t i32_field;
  OneOfEach struct_field;
  std::vector<RandomStuff>  struct_list;
  int32_t other_i32_field;
...
class ComparableUnion : public virtual ::apache::thrift::TBase {
 public:
  ...
  ComparableUnion() noexcept
                  : string_field(),
                    binary_field() {
  }

  virtual ~ComparableUnion() noexcept;
  std::string string_field;
...
class StructWithAUnion : public virtual ::apache::thrift::TBase {
 public:
  ...
  StructWithAUnion() noexcept {
  }

  virtual ~StructWithAUnion() noexcept;
...
class PrimitiveThenStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  PrimitiveThenStruct(const PrimitiveThenStruct&) noexcept;
  PrimitiveThenStruct& operator=(const PrimitiveThenStruct&) noexcept;
  PrimitiveThenStruct() noexcept
                      : blah(0),
                        blah2(0) {
  }

  virtual ~PrimitiveThenStruct() noexcept;
  int32_t blah;
  int32_t blah2;
  Backwards bw;
...
class StructWithASomemap : public virtual ::apache::thrift::TBase {
 public:
  ...
  StructWithASomemap() noexcept {
  }

  virtual ~StructWithASomemap() noexcept;
...
class BigFieldIdStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  BigFieldIdStruct() noexcept
                   : field1(),
                     field2() {
  }

  virtual ~BigFieldIdStruct() noexcept;
  std::string field1;
  std::string field2;
...
class BreaksRubyCompactProtocol : public virtual ::apache::thrift::TBase {
 public:
  ...
  BreaksRubyCompactProtocol() noexcept
                            : field1(),
                              field3(0) {
  }

  virtual ~BreaksRubyCompactProtocol() noexcept;
  std::string field1;
...
class TupleProtocolTestStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  TupleProtocolTestStruct(const TupleProtocolTestStruct&) noexcept;
  TupleProtocolTestStruct& operator=(const TupleProtocolTestStruct&) noexcept;
  TupleProtocolTestStruct() noexcept
                          : field1(0),
                            field2(0),
                            field3(0),
                            field4(0),
  ...
  virtual ~TupleProtocolTestStruct() noexcept;
  int32_t field1;
  int32_t field2;
  int32_t field3;
  int32_t field4;
...
class ListDoublePerf : public virtual ::apache::thrift::TBase {
 public:
  ...
  ListDoublePerf() noexcept {
  }

  virtual ~ListDoublePerf() noexcept;
