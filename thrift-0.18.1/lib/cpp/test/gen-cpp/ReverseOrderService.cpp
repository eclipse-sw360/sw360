...
ReverseOrderService_myMethod_args::~ReverseOrderService_myMethod_args() noexcept {
}
...
ReverseOrderService_myMethod_pargs::~ReverseOrderService_myMethod_pargs() noexcept {
}
...
ReverseOrderService_myMethod_result::~ReverseOrderService_myMethod_result() noexcept {
}
...
ReverseOrderService_myMethod_presult::~ReverseOrderService_myMethod_presult() noexcept {
}
...
::std::shared_ptr< ::apache::thrift::TProcessor > ReverseOrderServiceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ReverseOrderServiceIfFactory > cleanup(handlerFactory_);
  ::std::shared_ptr< ReverseOrderServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::std::shared_ptr< ::apache::thrift::TProcessor > processor(new ReverseOrderServiceProcessor(handler));
  return processor;
}
