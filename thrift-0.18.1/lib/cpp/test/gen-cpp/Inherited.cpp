...
Inherited_identity_args::~Inherited_identity_args() noexcept {
}
...
Inherited_identity_pargs::~Inherited_identity_pargs() noexcept {
}
...
Inherited_identity_result::~Inherited_identity_result() noexcept {
}
...
Inherited_identity_presult::~Inherited_identity_presult() noexcept {
}
...
::std::shared_ptr< ::apache::thrift::TProcessor > InheritedProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< InheritedIfFactory > cleanup(handlerFactory_);
  ::std::shared_ptr< InheritedIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::std::shared_ptr< ::apache::thrift::TProcessor > processor(new InheritedProcessor(handler));
  return processor;
}
