...
template <class Protocol_>
::std::shared_ptr< ::apache::thrift::TProcessor > ParentServiceProcessorFactoryT<Protocol_>::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ParentServiceIfFactory > cleanup(handlerFactory_);
  ::std::shared_ptr< ParentServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::std::shared_ptr< ::apache::thrift::TProcessor > processor(new ParentServiceProcessorT<Protocol_>(handler));
  return processor;
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::incrementGeneration(::std::function<void(ParentServiceCobClientT<Protocol_>* client)> cob)
{
  send_incrementGeneration();
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::getGeneration(::std::function<void(ParentServiceCobClientT<Protocol_>* client)> cob)
{
  send_getGeneration();
  this->channel_->sendAndRecvMessage(::std::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::addString(::std::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& s)
{
  send_addString(s);
  this->channel_->sendAndRecvMessage(::std::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::getStrings(::std::function<void(ParentServiceCobClientT<Protocol_>* client)> cob)
{
  send_getStrings();
  this->channel_->sendAndRecvMessage(::std::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::getDataWait(::std::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const int32_t length)
{
  send_getDataWait(length);
  this->channel_->sendAndRecvMessage(::std::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::onewayWait(::std::function<void(ParentServiceCobClientT<Protocol_>* client)> cob)
{
  send_onewayWait();
  this->channel_->sendMessage(::std::bind(cob, this), this->otrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::exceptionWait(::std::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& message)
{
  send_exceptionWait(message);
  this->channel_->sendAndRecvMessage(::std::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::unexpectedExceptionWait(::std::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& message)
{
  send_unexpectedExceptionWait(message);
  this->channel_->sendAndRecvMessage(::std::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::dispatchCall(::std::function<void(bool ok)> cob, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, const std::string& fname, int32_t seqid) {
  typename ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
    iprot->skip(::apache::thrift::protocol::T_STRUCT);
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::dispatchCallTemplated(::std::function<void(bool ok)> cob, Protocol_* iprot, Protocol_* oprot, const std::string& fname, int32_t seqid) {
  typename ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
    iprot->skip(::apache::thrift::protocol::T_STRUCT);
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_incrementGeneration(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  ...
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("ParentService.incrementGeneration", nullptr);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "ParentService.incrementGeneration");
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_incrementGeneration;
  iface_->incrementGeneration(
      ::std::bind(return_fn, this, cob, seqid, oprot, ctx, ::std::placeholders::_1));
}

template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_incrementGeneration(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_incrementGeneration(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_incrementGeneration_args args;
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_incrementGeneration;
  iface_->incrementGeneration(
      ::std::bind(return_fn, this, cob, seqid, oprot, ctx, ::std::placeholders::_1));
}
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_incrementGeneration(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return)
{
  ParentService_incrementGeneration_presult result;
  result.success = const_cast<int32_t*>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getGeneration(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("ParentService.getGeneration", nullptr);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "ParentService.getGeneration");
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getGeneration(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getGeneration(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_getGeneration_args args;
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getGeneration(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return)
{
  ParentService_getGeneration_presult result;
  result.success = const_cast<int32_t*>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_addString(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("ParentService.addString", nullptr);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "ParentService.addString");
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_addString;
  iface_->addString(
      ::std::bind(return_fn, this, cob, seqid, oprot, ctx),
      args.s);
}

template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_addString(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_addString(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_addString_args args;
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_addString;
  iface_->addString(
      ::std::bind(return_fn, this, cob, seqid, oprot, ctx),
      args.s);
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_addString(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx)
{
  ParentService_addString_presult result;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getStrings(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("ParentService.getStrings", nullptr);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "ParentService.getStrings");
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<std::string> & _return) =
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getStrings(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<std::string> & _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getStrings(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_getStrings_args args;
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::vector<std::string> & _return) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_getStrings;
  iface_->getStrings(
      ::std::bind(return_fn, this, cob, seqid, oprot, ctx, ::std::placeholders::_1));
}
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getStrings(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::vector<std::string> & _return)
{
  ParentService_getStrings_presult result;
  result.success = const_cast<std::vector<std::string> *>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getDataWait(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("ParentService.getDataWait", nullptr);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "ParentService.getDataWait");
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return) =
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getDataWait(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getDataWait(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_getDataWait_args args;
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::string& _return) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_getDataWait;
  iface_->getDataWait(
      ::std::bind(return_fn, this, cob, seqid, oprot, ctx, ::std::placeholders::_1),
      args.length);
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getDataWait(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::string& _return)
{
  ParentService_getDataWait_presult result;
  result.success = const_cast<std::string*>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_onewayWait(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("ParentService.onewayWait", nullptr);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "ParentService.onewayWait");
  ...
  freer.unregister();
  iface_->onewayWait(::std::bind(cob, true)
);
}

template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_onewayWait(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  (void) seqid;
  (void) oprot;
  ParentService_onewayWait_args args;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_exceptionWait(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("ParentService.exceptionWait", nullptr);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "ParentService.exceptionWait");
  ...
  void (ParentServiceAsyncProcessorT<Protocol_>::*throw_fn)(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw) =
    &ParentServiceAsyncProcessorT<Protocol_>::throw_exceptionWait;
  iface_->exceptionWait(
      ::std::bind(return_fn, this, cob, seqid, oprot, ctx),
      ::std::bind(throw_fn, this, cob, seqid, oprot, ctx, ::std::placeholders::_1),
      args.message);
}

template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_exceptionWait(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::throw_exceptionWait(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_exceptionWait(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_exceptionWait_args args;
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
  ...
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_exceptionWait;
  void (ParentServiceAsyncProcessorT<Protocol_>::*throw_fn)(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw) =
    &ParentServiceAsyncProcessorT<Protocol_>::throw_exceptionWait;
  iface_->exceptionWait(
      ::std::bind(return_fn, this, cob, seqid, oprot, ctx),
      ::std::bind(throw_fn, this, cob, seqid, oprot, ctx, ::std::placeholders::_1),
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_exceptionWait(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx)
{
  ParentService_exceptionWait_presult result;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::throw_exceptionWait(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_unexpectedExceptionWait(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("ParentService.unexpectedExceptionWait", nullptr);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "ParentService.unexpectedExceptionWait");
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_unexpectedExceptionWait(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_unexpectedExceptionWait(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_unexpectedExceptionWait_args args;
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_unexpectedExceptionWait(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx)
{
  ParentService_unexpectedExceptionWait_presult result;
...
template <class Protocol_>
::std::shared_ptr< ::apache::thrift::async::TAsyncProcessor > ParentServiceAsyncProcessorFactoryT<Protocol_>::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ParentServiceCobSvIfFactory > cleanup(handlerFactory_);
  ::std::shared_ptr< ParentServiceCobSvIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::std::shared_ptr< ::apache::thrift::async::TAsyncProcessor > processor(new ParentServiceAsyncProcessorT<Protocol_>(handler));
  return processor;
}
