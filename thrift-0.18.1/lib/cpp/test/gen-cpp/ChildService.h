...
class ChildServiceIfFactory : virtual public ParentServiceIfFactory {
 public:
  ...
  virtual ChildServiceIf* getHandler(const ::apache::thrift::TConnectionInfo& connInfo) override = 0;
  virtual void releaseHandler(ParentServiceIf* /* handler */) override = 0;
  };

class ChildServiceIfSingletonFactory : virtual public ChildServiceIfFactory {
 public:
  ChildServiceIfSingletonFactory(const ::std::shared_ptr<ChildServiceIf>& iface) : iface_(iface) {}
  virtual ~ChildServiceIfSingletonFactory() {}

  virtual ChildServiceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(ParentServiceIf* /* handler */) override {}

 protected:
  ::std::shared_ptr<ChildServiceIf> iface_;
};
...
class ChildService_setValue_args {
 public:
  ...
  ChildService_setValue_args(const ChildService_setValue_args&) noexcept;
  ChildService_setValue_args& operator=(const ChildService_setValue_args&) noexcept;
  ChildService_setValue_args() noexcept
                             : value(0) {
  }

  virtual ~ChildService_setValue_args() noexcept;
  int32_t value;
...
class ChildService_setValue_pargs {
 public:
  ...
  virtual ~ChildService_setValue_pargs() noexcept;
  const int32_t* value;
...
class ChildService_setValue_result {
 public:
  ...
  ChildService_setValue_result(const ChildService_setValue_result&) noexcept;
  ChildService_setValue_result& operator=(const ChildService_setValue_result&) noexcept;
  ChildService_setValue_result() noexcept
                               : success(0) {
  }

  virtual ~ChildService_setValue_result() noexcept;
  int32_t success;
...
class ChildService_setValue_presult {
 public:
  ...
  virtual ~ChildService_setValue_presult() noexcept;
  int32_t* success;
...
class ChildService_getValue_args {
 public:
  ...
  ChildService_getValue_args(const ChildService_getValue_args&) noexcept;
  ChildService_getValue_args& operator=(const ChildService_getValue_args&) noexcept;
  ChildService_getValue_args() noexcept {
  }

  virtual ~ChildService_getValue_args() noexcept;
...
class ChildService_getValue_pargs {
 public:
  ...
  virtual ~ChildService_getValue_pargs() noexcept;
...
class ChildService_getValue_result {
 public:
  ...
  ChildService_getValue_result(const ChildService_getValue_result&) noexcept;
  ChildService_getValue_result& operator=(const ChildService_getValue_result&) noexcept;
  ChildService_getValue_result() noexcept
                               : success(0) {
  }

  virtual ~ChildService_getValue_result() noexcept;
  int32_t success;
...
class ChildService_getValue_presult {
 public:
  ...
  virtual ~ChildService_getValue_presult() noexcept;
  int32_t* success;
...
class ChildServiceClientT : virtual public ChildServiceIf, public ParentServiceClientT<Protocol_> {
 public:
  ChildServiceClientT(std::shared_ptr< Protocol_> prot) :
    ParentServiceClientT<Protocol_>(prot, prot) {}
  ChildServiceClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot) :    ParentServiceClientT<Protocol_>(iprot, oprot) {}
...
class ChildServiceProcessorT : public ParentServiceProcessorT<Protocol_> {
 ...
 public:
  ChildServiceProcessorT(::std::shared_ptr<ChildServiceIf> iface) :
...
class ChildServiceProcessorFactoryT : public ::apache::thrift::TProcessorFactory {
 public:
  ChildServiceProcessorFactoryT(const ::std::shared_ptr< ChildServiceIfFactory >& handlerFactory) noexcept :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) override;

 protected:
  ::std::shared_ptr< ChildServiceIfFactory > handlerFactory_;
};
...
class ChildServiceMultiface : virtual public ChildServiceIf, public ParentServiceMultiface {
 public:
  ChildServiceMultiface(std::vector<std::shared_ptr<ChildServiceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<std::shared_ptr<ChildServiceIf> >::iterator iter;
 ...
 protected:
  std::vector<std::shared_ptr<ChildServiceIf> > ifaces_;
  ChildServiceMultiface() {}
  void add(::std::shared_ptr<ChildServiceIf> iface) {
...
class ChildServiceConcurrentClientT : virtual public ChildServiceIf, public ParentServiceConcurrentClientT<Protocol_> {
 public:
  ChildServiceConcurrentClientT(std::shared_ptr< Protocol_> prot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) :
    ParentServiceConcurrentClientT<Protocol_>(prot, prot, sync) {}
  ChildServiceConcurrentClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) :    ParentServiceConcurrentClientT<Protocol_>(iprot, oprot, sync) {}
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return this->piprot_;
  }
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
...
class ChildServiceCobClIfT : virtual public ParentServiceCobClIfT<Protocol_> {
 public:
  ...
  virtual void setValue(::std::function<void(ChildServiceCobClientT<Protocol_>* client)> cob, const int32_t value) = 0;
  virtual void getValue(::std::function<void(ChildServiceCobClientT<Protocol_>* client)> cob) = 0;
};
...
class ChildServiceCobSvIf : virtual public ParentServiceCobSvIf {
 public:
  ...
  virtual void setValue(::std::function<void(int32_t const& _return)> cob, const int32_t value) = 0;
  virtual void getValue(::std::function<void(int32_t const& _return)> cob) = 0;
};
...
class ChildServiceCobSvIfFactory : virtual public ParentServiceCobSvIfFactory {
 public:
  ...
  virtual ChildServiceCobSvIf* getHandler(const ::apache::thrift::TConnectionInfo& connInfo) override = 0;
  virtual void releaseHandler(ParentServiceCobSvIf* /* handler */) override = 0;
  };

class ChildServiceCobSvIfSingletonFactory : virtual public ChildServiceCobSvIfFactory {
 public:
  ChildServiceCobSvIfSingletonFactory(const ::std::shared_ptr<ChildServiceCobSvIf>& iface) : iface_(iface) {}
  virtual ~ChildServiceCobSvIfSingletonFactory() {}

  virtual ChildServiceCobSvIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(ParentServiceCobSvIf* /* handler */) override {}

 protected:
  ::std::shared_ptr<ChildServiceCobSvIf> iface_;
};
...
class ChildServiceCobSvNull : virtual public ChildServiceCobSvIf , virtual public ParentServiceCobSvNull {
 public:
  ...
  void setValue(::std::function<void(int32_t const& _return)> cob, const int32_t /* value */) override {
    int32_t _return = 0;
    return cob(_return);
  }
  void getValue(::std::function<void(int32_t const& _return)> cob) override {
    int32_t _return = 0;
    return cob(_return);
  }
};
...
class ChildServiceCobClientT : virtual public ChildServiceCobClIfT<Protocol_>, public ParentServiceCobClientT<Protocol_> {
 public:
  ChildServiceCobClientT(std::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
  ...
  void setValue(::std::function<void(ChildServiceCobClientT<Protocol_>* client)> cob, const int32_t value) override;
  void send_setValue(const int32_t value);
  int32_t recv_setValue();
  void getValue(::std::function<void(ChildServiceCobClientT<Protocol_>* client)> cob) override;
  void send_getValue();
  int32_t recv_getValue();
};
...
class ChildServiceAsyncProcessorT : public ParentServiceAsyncProcessorT<Protocol_> {
 ...
 private:
  typedef  void (ChildServiceAsyncProcessorT::*ProcessFunction)(::std::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef void (ChildServiceAsyncProcessorT::*SpecializedProcessFunction)(::std::function<void(bool ok)>, int32_t, Protocol_*, Protocol_*);
  struct ProcessFunctions {
    ProcessFunction generic;
    SpecializedProcessFunction specialized;
    ProcessFunctions(ProcessFunction g, SpecializedProcessFunction s) :
  ...
  typedef std::map<std::string, ProcessFunctions> ProcessMap;
  ProcessMap processMap_;
  void process_setValue(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_setValue(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_setValue(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void return_setValue(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return);
  void throw_setValue(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_setValue(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_getValue(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getValue(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_getValue(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void return_getValue(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return);
  void throw_getValue(::std::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_getValue(::std::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  ChildServiceAsyncProcessorT(::std::shared_ptr<ChildServiceCobSvIf> iface) :
...
class ChildServiceAsyncProcessorFactoryT : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  ChildServiceAsyncProcessorFactoryT(const ::std::shared_ptr< ChildServiceCobSvIfFactory >& handlerFactory) noexcept :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::async::TAsyncProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) override;

 protected:
  ::std::shared_ptr< ChildServiceCobSvIfFactory > handlerFactory_;
};
