...
class Simple : public virtual ::apache::thrift::TBase {
 public:
  ...
  Simple(const Simple&) noexcept;
  Simple& operator=(const Simple&) noexcept;
  Simple() noexcept
         : im_default(0),
           im_required(0),
           im_optional(0) {
...
class Tricky1 : public virtual ::apache::thrift::TBase {
 public:
  ...
  Tricky1(const Tricky1&) noexcept;
  Tricky1& operator=(const Tricky1&) noexcept;
  Tricky1() noexcept
          : im_default(0) {
  }

  virtual ~Tricky1() noexcept;
  int16_t im_default;
...
class Tricky2 : public virtual ::apache::thrift::TBase {
 public:
  ...
  Tricky2(const Tricky2&) noexcept;
  Tricky2& operator=(const Tricky2&) noexcept;
  Tricky2() noexcept
          : im_optional(0) {
  }

  virtual ~Tricky2() noexcept;
  int16_t im_optional;
...
class Tricky3 : public virtual ::apache::thrift::TBase {
 public:
  ...
  Tricky3(const Tricky3&) noexcept;
  Tricky3& operator=(const Tricky3&) noexcept;
  Tricky3() noexcept
          : im_required(0) {
  }

  virtual ~Tricky3() noexcept;
  int16_t im_required;
...
class OptionalDefault : public virtual ::apache::thrift::TBase {
 public:
  ...
  OptionalDefault() : opt_int(1234),
                      opt_str("default") {
  }

  virtual ~OptionalDefault() noexcept;
  int16_t opt_int;
  std::string opt_str;
...
class ManyOpt : public virtual ::apache::thrift::TBase {
 public:
  ...
  ManyOpt(const ManyOpt&) noexcept;
  ManyOpt& operator=(const ManyOpt&) noexcept;
  ManyOpt() noexcept
          : opt1(0),
            opt2(0),
            opt3(0),
...
class JavaTestHelper : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~JavaTestHelper() noexcept;
  int32_t req_int;
  int32_t opt_int;
  std::string req_obj;
  std::string opt_obj;
