...
RecList::~RecList() noexcept {
}


void RecList::__set_nextitem(::std::shared_ptr<RecList> val) {
  this->nextitem = val;
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          if (!this->nextitem) { 
            this->nextitem = ::std::shared_ptr<RecList>(new RecList);
          }
...
RecList::RecList(const RecList& other8) noexcept {
  nextitem = other8.nextitem;
  item = other8.item;
  __isset = other8.__isset;
}
RecList& RecList::operator=(const RecList& other9) noexcept {
...
CoRec::~CoRec() noexcept {
}


void CoRec::__set_other(::std::shared_ptr<CoRec2> val) {
  this->other = val;
}
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          if (!this->other) { 
            this->other = ::std::shared_ptr<CoRec2>(new CoRec2);
          }
...
CoRec::CoRec(const CoRec& other10) noexcept {
  other = other10.other;
  __isset = other10.__isset;
}
CoRec& CoRec::operator=(const CoRec& other11) noexcept {
  other = other11.other;
...
CoRec2::CoRec2(const CoRec2& other12) noexcept {
  other = other12.other;
  __isset = other12.__isset;
}
CoRec2& CoRec2::operator=(const CoRec2& other13) noexcept {
  other = other13.other;
...
VectorTest::~VectorTest() noexcept {
}
