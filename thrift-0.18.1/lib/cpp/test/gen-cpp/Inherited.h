...
class InheritedIfFactory : virtual public SrvIfFactory {
 public:
  ...
  virtual InheritedIf* getHandler(const ::apache::thrift::TConnectionInfo& connInfo) override = 0;
  virtual void releaseHandler(SrvIf* /* handler */) override = 0;
  };

class InheritedIfSingletonFactory : virtual public InheritedIfFactory {
 public:
  InheritedIfSingletonFactory(const ::std::shared_ptr<InheritedIf>& iface) : iface_(iface) {}
  virtual ~InheritedIfSingletonFactory() {}

  virtual InheritedIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(SrvIf* /* handler */) override {}

 protected:
  ::std::shared_ptr<InheritedIf> iface_;
};

class InheritedNull : virtual public InheritedIf , virtual public SrvNull {
 public:
  virtual ~InheritedNull() {}
  int32_t identity(const int32_t /* arg */) override {
    int32_t _return = 0;
    return _return;
  }
};
...
class Inherited_identity_args {
 public:
  ...
  Inherited_identity_args(const Inherited_identity_args&) noexcept;
  Inherited_identity_args& operator=(const Inherited_identity_args&) noexcept;
  Inherited_identity_args() noexcept
                          : arg(0) {
  }

  virtual ~Inherited_identity_args() noexcept;
  int32_t arg;
...
class Inherited_identity_pargs {
 public:
  ...
  virtual ~Inherited_identity_pargs() noexcept;
  const int32_t* arg;
...
class Inherited_identity_result {
 public:
  ...
  Inherited_identity_result(const Inherited_identity_result&) noexcept;
  Inherited_identity_result& operator=(const Inherited_identity_result&) noexcept;
  Inherited_identity_result() noexcept
                            : success(0) {
  }

  virtual ~Inherited_identity_result() noexcept;
  int32_t success;
...
class Inherited_identity_presult {
 public:
  ...
  virtual ~Inherited_identity_presult() noexcept;
  int32_t* success;
...
class InheritedClient : virtual public InheritedIf, public SrvClient {
 public:
  InheritedClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    SrvClient(prot, prot) {}
  InheritedClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    SrvClient(iprot, oprot) {}
...
class InheritedProcessor : public SrvProcessor {
 ...
 public:
  InheritedProcessor(::std::shared_ptr<InheritedIf> iface) :
    SrvProcessor(iface),
    iface_(iface) {
...
class InheritedProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  InheritedProcessorFactory(const ::std::shared_ptr< InheritedIfFactory >& handlerFactory) noexcept :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) override;

 protected:
  ::std::shared_ptr< InheritedIfFactory > handlerFactory_;
};

class InheritedMultiface : virtual public InheritedIf, public SrvMultiface {
 public:
  InheritedMultiface(std::vector<std::shared_ptr<InheritedIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<std::shared_ptr<InheritedIf> >::iterator iter;
 ...
 protected:
  std::vector<std::shared_ptr<InheritedIf> > ifaces_;
  InheritedMultiface() {}
  void add(::std::shared_ptr<InheritedIf> iface) {
...
class InheritedConcurrentClient : virtual public InheritedIf, public SrvConcurrentClient {
 public:
  InheritedConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) :
    SrvConcurrentClient(prot, prot, sync) {}
  InheritedConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) :    SrvConcurrentClient(iprot, oprot, sync) {}
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
