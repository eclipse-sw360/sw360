...
ServiceForExceptionWithAMap_methodThatThrowsAnException_args::~ServiceForExceptionWithAMap_methodThatThrowsAnException_args() noexcept {
}
...
ServiceForExceptionWithAMap_methodThatThrowsAnException_pargs::~ServiceForExceptionWithAMap_methodThatThrowsAnException_pargs() noexcept {
}
...
ServiceForExceptionWithAMap_methodThatThrowsAnException_result::~ServiceForExceptionWithAMap_methodThatThrowsAnException_result() noexcept {
}
...
ServiceForExceptionWithAMap_methodThatThrowsAnException_presult::~ServiceForExceptionWithAMap_methodThatThrowsAnException_presult() noexcept {
}
...
::std::shared_ptr< ::apache::thrift::TProcessor > ServiceForExceptionWithAMapProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ServiceForExceptionWithAMapIfFactory > cleanup(handlerFactory_);
  ::std::shared_ptr< ServiceForExceptionWithAMapIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::std::shared_ptr< ::apache::thrift::TProcessor > processor(new ServiceForExceptionWithAMapProcessor(handler));
  return processor;
}
