...
class MyStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  MyStruct& operator=(const MyStruct&) noexcept;
  MyStruct() noexcept
           : me2_2(static_cast<MyEnum2::type>(2)),
             me3_n2(static_cast<MyEnum3::type>(-2)),
             me3_d1(static_cast<MyEnum3::type>(1)) {
  }
...
class EnumTestStruct : public virtual ::apache::thrift::TBase {
 public:
  ...
  EnumTestStruct() noexcept
                 : a_enum(static_cast<MyEnum3::type>(0)) {
  }

  virtual ~EnumTestStruct() noexcept;
  /**
   * 
   * @see MyEnum3
   */
