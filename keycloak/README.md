...
* Build the SW360 backend code using Maven,
  `mvn clean install -DskipTests -Dbase.deploy.dir=/opt/apache-tomcat-10.x.x/ -Dlistener.deploy.dir=/opt/keycloak-24.x.x/providers -P deploy`
...
* After building the backend with deploy profile, following files should be copied to /opt/keycloak-24.0.2/providers/:
```
