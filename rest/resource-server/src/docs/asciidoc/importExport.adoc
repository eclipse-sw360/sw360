...
A `GET` request help to download the attachment template in csv format.
...
A `GET` request help to download the attachment information in csv format.
...
A `GET` request help to download the release link sample in csv format.
...
A `GET` request help to download the release link information in csv format.
