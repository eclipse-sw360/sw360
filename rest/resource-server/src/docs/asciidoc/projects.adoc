...
===== Request parameter
include::{snippets}/should_document_get_project_releases_ecc_information/request-parameters.adoc[]
...
[[resources-projects-get-grouplist]]
==== Fetch a list of group list.
