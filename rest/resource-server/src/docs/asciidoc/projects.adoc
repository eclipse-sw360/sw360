...
[[resources-projects-duplicate-with-network]]
==== Duplicate a project with dependencies network

A `POST` request is used to duplicate a project with dependencies network

===== Request structure
include::{snippets}/should_document_duplicate_project_with_dependency_network/request-fields.adoc[]

===== Example request
include::{snippets}/should_document_duplicate_project_with_dependency_network/curl-request.adoc[]

===== Example response
include::{snippets}/should_document_duplicate_project_with_dependency_network/http-response.adoc[]

[[resources-linked-releases-in-dependency-network-of-project]]
==== Get linked releases in dependency network of a project

A `GET` request is used to get linked releases in dependency network of a project.

===== Example request
include::{snippets}/should_document_get_linked_releases_in_dependency_network_of_project/curl-request.adoc[]

===== Example response
include::{snippets}/should_document_get_linked_releases_in_dependency_network_of_project/http-response.adoc[]
...
[[resources-get-linked-releases-of-linked-projects]]
==== Get linked releases of linked projects

A `GET` request is used to Get linked releases of linked projects.

===== Response structure
include::{snippets}/should_document_get_linked_releases_of_linked_projects/response-fields.adoc[]

===== Example request
include::{snippets}/should_document_get_linked_releases_of_linked_projects/curl-request.adoc[]

===== Example response
include::{snippets}/should_document_get_linked_releases_of_linked_projects/http-response.adoc[]

[[resources-compare-dependency-network-with-relationship-between-releases]]
==== Compare dependency network with default network (relationships between releases)

A `POST` request is used to compare dependency network with default network (relationships between releases).

===== Example request
include::{snippets}/should_document_compare_dependency_network_with_default_releases_relationship/curl-request.adoc[]
