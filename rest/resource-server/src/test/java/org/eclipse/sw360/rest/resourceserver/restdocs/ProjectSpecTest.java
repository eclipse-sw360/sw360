...
public class ProjectSpecTest extends TestRestDocsSpecBase {
    ...
    public void before() throws TException, IOException, ResourceClassNotFoundException, PaginationParameterException, URISyntaxException {
        ...
        project.setVendor((new  Vendor("Test", "Test short", "http://testvendoraddress.com").setId("987567468")));
        ...
        release.setVendor(new Vendor("TV", "Test Vendor", "http://testvendor.com"));
        ...
        release2.setAdditionalData(Collections.singletonMap("Key", "Value"));
        release2.setLanguages(new HashSet<>(Arrays.asList("C++", "Java")));
        release2.setMainLicenseIds(new HashSet<>(Arrays.asList("GPL-2.0-or-later", "Apache-2.0")));
        ...
        mockMvc.perform(get("/api/projects")
                ...
                .andDo(this.documentationHandler.document(
                        ...
                        responseFields(
                                ...
                                subsectionWithPath("_embedded.sw360:projectDTOes[]considerReleasesFromExternalList").description("Consider list of releases from existing external list"),
                                ...
                                subsectionWithPath("_embedded.sw360:projectDTOes.[]vendor").description("An array of all component vendors with full name and link to their <<resources-vendor-get,Vendor resource>>"),
                                subsectionWithPath("_links").description("<<resources-index-links,Links>> to other resources"),
                                fieldWithPath("page").description("Additional paging information"),
                                fieldWithPath("page.size").description("Number of projects per page"),
                                fieldWithPath("page.totalElements").description("Total number of all existing projects"),
    ...
    private void add_patch_releases_with_project_release_relation(MockHttpServletRequestBuilder requestBuilder)
        ...
        ImmutableMap<String, ProjectReleaseRelationship> releaseIdToUsage = ImmutableMap
                .<String, ProjectReleaseRelationship>builder().put("3765276512", projectReleaseRelationship1)
                .put("5578999", projectReleaseRelationship2).build();
        String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
        this.mockMvc.perform(requestBuilder.contentType(MediaTypes.HAL_JSON)
