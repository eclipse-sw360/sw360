...
public class ViewerRoleAccessTest extends TestRestDocsSpecBase {
    ...
    @Test
    public void should_deny_viewer_access_to_linked_projects() throws Exception {
    ...
    @Test
    public void should_deny_viewer_access_to_linked_projects_releases() throws Exception {
    ...
    // ---- Positive: VIEWER CAN read components and licenses ----
