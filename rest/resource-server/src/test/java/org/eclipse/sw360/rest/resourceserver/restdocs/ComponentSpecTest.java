...
public class ComponentSpecTest extends TestRestDocsSpecBase {
	...
	public void before() throws TException, IOException {
		...
		Component testComponent = new Component().setAttachments(setOfAttachment).setId("98745")
				.setName("Test Component").setComponentType(ComponentType.CODE_SNIPPET).setCreatedOn("2021-04-27")
				.setCreatedBy("admin@sw360.org").setCategories(ImmutableSet.of("java", "javascript", "sql"));
		...
		angularComponent
				.setDescription("Angular is a development platform for building mobile and desktop web applications.");
		...
		springComponent.setDescription(
		...
		when(this.componentServiceMock.createComponent(any(), any()))
				.then(invocation -> new Component("Spring Framework").setDescription(
						"The Spring Framework provides a comprehensive programming and configuration model for modern Java-based enterprise applications.")
						.setComponentType(ComponentType.OSS).setId("1234567890").setCreatedBy("admin@sw360.org")
		...
		given(this.componentServiceMock.getUsingComponentsForComponent(eq("17653524"), any()))
				.willReturn(usedByComponent);
		given(this.componentServiceMock.searchComponentByName(eq(angularComponent.getName())))
				.willReturn(componentListByName);
		given(this.componentServiceMock.deleteComponent(eq(angularComponent.getId()), any()))
				.willReturn(RequestStatus.SUCCESS);
		given(this.componentServiceMock.searchByExternalIds(eq(externalIds), any()))
				.willReturn((new HashSet<>(componentList)));
		given(this.componentServiceMock.convertToEmbeddedWithExternalIds(eq(angularComponent)))
				.willReturn(new Component("Angular").setId("17653524").setComponentType(ComponentType.OSS)
						.setExternalIds(Collections.singletonMap("component-id-key", "1831A3")));
		given(this.componentServiceMock.convertToEmbeddedWithExternalIds(eq(springComponent)))
				.willReturn(new Component("Spring Framework").setId("678dstzd8").setComponentType(ComponentType.OSS)
		...
		given(this.userServiceMock.getUserByEmail("admin@sw360.org"))
				.willReturn(new User("admin@sw360.org", "sw360").setId("123456789"));
		given(this.userServiceMock.getUserByEmail("john@sw360.org"))
				.willReturn(new User("john@sw360.org", "sw360").setId("74427996"));
	...
	public void should_document_get_components() throws Exception {
		...
		mockMvc.perform(get("/api/components").header("Authorization", "Bearer " + accessToken).param("page", "0")
				.param("page_entries", "5").param("sort", "name,desc").accept(MediaTypes.HAL_JSON))
				.andExpect(status().isOk())
				.andDo(this.documentationHandler
						.document(
								requestParameters(parameterWithName("page").description("Page of components"),
								...
								responseFields(
										...
										subsectionWithPath("_embedded.sw360:components").description(
												"An array of <<resources-components, Components resources>>"),
										...
										fieldWithPath("page.totalElements")
												.description("Total number of all existing components"),
	...
	public void should_document_get_components_no_paging_params() throws Exception {
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		mockMvc.perform(
				get("/api/components").header("Authorization", "Bearer " + accessToken).accept(MediaTypes.HAL_JSON))
				.andExpect(status().isOk())
	...
	public void should_document_get_components_with_fields() throws Exception {
		...
		mockMvc.perform(get("/api/components")
				.header("Authorization", "Bearer " + accessToken).param("fields", "ownerGroup,ownerCountry")
				.param("page", "0").param("page_entries", "5").param("sort", "name,desc").accept(MediaTypes.HAL_JSON))
				.andExpect(status().isOk())
				.andDo(this.documentationHandler.document(
						requestParameters(
								parameterWithName("fields").description(
										"Properties which should be present for each component in the result"),
						...
						responseFields(
								subsectionWithPath("_embedded.sw360:components.[]name")
										.description("The name of the component"),
								subsectionWithPath("_embedded.sw360:components.[]ownerGroup")
										.description("The ownerGroup of the component"),
								subsectionWithPath("_embedded.sw360:components.[]ownerCountry")
										.description("The ownerCountry of the component"),
								subsectionWithPath("_embedded.sw360:components.[]componentType")
										.description("The component type, possible values are: "
												+ Arrays.asList(ComponentType.values())),
								subsectionWithPath("_embedded.sw360:components")
	...
	public void should_document_get_component() throws Exception {
		...
		mockMvc.perform(get("/api/components/17653524")
				...
				.andExpect(status().isOk())
				.andDo(this.documentationHandler.document(
						links(linkWithRel("self").description("The <<resources-components,Component resource>>")),
						responseFields(fieldWithPath("name").description("The name of the component"),
								fieldWithPath("componentType").description("The component type, possible values are: "
										+ Arrays.asList(ComponentType.values())),
								...
								fieldWithPath("ownerAccountingUnit")
										.description("The owner accounting unit of the component"),
								...
								subsectionWithPath("externalIds").description(
										"When components are imported from other tools, the external ids can be stored here. Store as 'Single String' when single value, or 'Array of String' when multi-values"),
								...
								subsectionWithPath("_embedded.createdBy")
										.description("The user who created this component"),
								subsectionWithPath("_embedded.sw360:releases").description(
										"An array of all component releases with version and link to their <<resources-releases,Releases resource>>"),
								subsectionWithPath("_embedded.sw360:moderators").description(
										"An array of all component moderators with email and link to their <<resources-user-get,User resource>>"),
								...
								subsectionWithPath("_embedded.sw360:attachments").description(
										"An array of all component attachments and link to their <<resources-attachment-get,Attachment resource>>"),
								...
								fieldWithPath("setBusinessUnit")
										.description("Whether or not a business unit is set for the component"))));
	}
	...
	public void should_document_create_component() throws Exception {
		...
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		this.mockMvc
				.perform(post("/api/components").contentType(MediaTypes.HAL_JSON)
				...
				.andDo(this.documentationHandler.document(
						requestFields(fieldWithPath("name").description("The name of the component"),
								fieldWithPath("description").description("The component description"),
								fieldWithPath("componentType").description("The component type, possible values are: "
										+ Arrays.asList(ComponentType.values())),
								fieldWithPath("homepage").description("The homepage url of the component")),
	...
	public void should_document_get_components_by_type() throws Exception {
		...
		mockMvc.perform(get("/api/components?type=" + angularComponent.getComponentType())
				.header("Authorization", "Bearer " + accessToken).param("page", "0").param("page_entries", "5")
				.param("sort", "name,desc").accept(MediaTypes.HAL_JSON)).andExpect(status().isOk())
				.andDo(this.documentationHandler.document(
						requestParameters(parameterWithName("type").description("Filter for type"),
								parameterWithName("page").description("Page of components"),
								parameterWithName("page_entries").description("Amount of components per page"),
								parameterWithName("sort").description("Defines order of the components")),
						links(linkWithRel("curies").description("Curies are used for online documentation"),
	...
	public void should_document_get_components_by_name() throws Exception {
		...
		mockMvc.perform(get("/api/components?name=" + angularComponent.getName())
				...
				.param("sort", "name,desc").accept(MediaTypes.HAL_JSON)).andExpect(status().isOk())
				.andDo(this.documentationHandler.document(
						requestParameters(parameterWithName("name").description("Filter for name"),
								parameterWithName("page").description("Page of components"),
								parameterWithName("page_entries").description("Amount of components per page"),
								parameterWithName("sort").description("Defines order of the components")),
						links(linkWithRel("curies").description("Curies are used for online documentation"),
	...
	public void should_document_update_component() throws Exception {
		...
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		mockMvc.perform(patch("/api/components/17653524").contentType(MediaTypes.HAL_JSON)
				.content(this.objectMapper.writeValueAsString(updateComponent))
				.header("Authorization", "Bearer " + accessToken).accept(MediaTypes.HAL_JSON))
				.andExpect(status().isOk()).andDo(documentComponentProperties());
	}
	...
	public void should_document_get_component_attachment() throws Exception {
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		mockMvc.perform(get(
				"/api/components/" + angularComponent.getId() + "/attachments/" + attachment.getAttachmentContentId())
		...
		mockMvc.perform(get("/api/components/searchByExternalIds?component-id-key=1831A3&component-id-key=c77321")
				...
				.andDo(this.documentationHandler.document(responseFields(
						...
						subsectionWithPath("_embedded.sw360:components.[]componentType").description(
								"The component type, possible values are: " + Arrays.asList(ComponentType.values())),
						subsectionWithPath("_embedded.sw360:components.[]name")
								.description("The name of the component, optional"),
						subsectionWithPath("_embedded.sw360:components.[]externalIds").description(
								"External Ids of the component. Return as 'Single String' when single value, or 'Array of String' when multi-values"),
						subsectionWithPath("_links")
								.description("<<resources-index-links,Links>> to other resources"))));
	}
	...
	private RestDocumentationResultHandler documentComponentProperties() {
		return this.documentationHandler.document(
				links(linkWithRel("self").description("The <<resources-components,Component resource>>")),
				responseFields(fieldWithPath("name").description("The name of the component"),
						fieldWithPath("componentType").description(
								"The component type, possible values are: " + Arrays.asList(ComponentType.values())),
						fieldWithPath("description").description("The component description"),
						fieldWithPath("createdOn").description("The date the component was created"),
						fieldWithPath("componentOwner").description("The owner name of the component"),
						...
						subsectionWithPath("_embedded.sw360:moderators").description(
								"An array of all component moderators with email and link to their <<resources-user-get,User resource>>"),
						subsectionWithPath("_embedded.sw360:vendors").description(
								"An array of all component vendors with ful name and link to their <<resources-vendor-get,Vendor resource>>"),
						subsectionWithPath("_embedded.sw360:attachments").description(
								"An array of all component attachments and link to their <<resources-attachment-get,Attachment resource>>"),
						fieldWithPath("visbility").description("The visibility type of the component"),
						fieldWithPath("setVisbility").description("The visibility of the component"),
