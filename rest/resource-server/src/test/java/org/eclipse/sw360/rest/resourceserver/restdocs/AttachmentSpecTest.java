		...
		mockMvc.perform(get("/api/attachments/" + attachment.getAttachmentContentId())
				...
				.andDo(this.documentationHandler.document(
						links(linkWithRel("self").description("The <<resources-projects,Projects resource>>"),
								linkWithRel("sw360:downloadLink")
										.description("The download link (URL) of the resource"),
								linkWithRel("curies").description("Curies are used for online documentation")),
						responseFields(fieldWithPath("filename").description("The filename of the attachment"),
								fieldWithPath("sha1").description("The attachment's file contents sha1 hash"),
								fieldWithPath("attachmentType").description("The attachment type, possible values are "
								...
								fieldWithPath("checkStatus").description("The checking status. possible values are "
								...
								subsectionWithPath("_embedded.sw360:releases")
										.description("The release this attachment belongs to"),
