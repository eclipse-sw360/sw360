...
public class Sw360AttachmentServiceTest {
	...
	private static Set<Attachment> createAttachmentSet(int count) {
		return IntStream.range(1, count + 1).mapToObj(Sw360AttachmentServiceTest::createAttachment)
	...
	public void testFilterAttachmentsToRemoveAllValid() throws TException {
		...
		when(thriftService.getAttachmentUsages(owner, attachmentId(2), null)).thenReturn(Arrays.asList(usage1, usage2));
	...
	public void testFilterAttachmentsToRemoveEvaluatesAttachmentUsages() throws TException {
		...
		when(thriftService.getAttachmentUsages(owner, attachmentId(1), null)).thenReturn(usages1);
		when(thriftService.getAttachmentUsages(owner, attachmentId(2), null)).thenReturn(usages2);
	...
	public void testFilterAttachmentsToRemoveEvaluatesCheckStatus() throws TException {
		...
		when(thriftService.getAttachmentUsages(any(), anyString(), any())).thenReturn(Collections.emptyList());
	...
	public void testFilterAttachmentsToRemoveHandlesExceptions() throws TException {
		...
		when(thriftService.getAttachmentUsages(owner, attachmentId(2), null)).thenReturn(Collections.emptyList());
		Set<Attachment> allAttachments = createAttachmentSet(3);
