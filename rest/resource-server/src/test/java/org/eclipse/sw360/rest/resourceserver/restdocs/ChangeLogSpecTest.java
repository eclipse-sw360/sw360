...
public class ChangeLogSpecTest extends TestRestDocsSpecBase {
	...
	public void should_document_get_changelog_by_documentid() throws Exception {
		...
		mockMvc.perform(
				get("/api/changelog/document/4567").header("Authorization", "Bearer " + accessToken).param("page", "0")
						.param("page_entries", "5").param("sort", "changeTimestamp,asc").accept(MediaTypes.HAL_JSON))
				.andExpect(status().isOk())
				.andDo(this.documentationHandler.document(
						requestParameters(parameterWithName("page").description("Page of changelogs"),
						...
						responseFields(
								subsectionWithPath("_embedded.sw360:changeLogs[]id")
										.description("The id of the resource"),
								subsectionWithPath("_embedded.sw360:changeLogs[]documentId")
										.description("The id of the document"),
								subsectionWithPath("_embedded.sw360:changeLogs[]documentType")
										.description("The type of the document. Possible values are " + docType),
								subsectionWithPath("_embedded.sw360:changeLogs[]operation")
										.description("The type of the operation. Possible values are "
												+ Arrays.asList(Operation.values())),
								subsectionWithPath("_embedded.sw360:changeLogs[]userEdited")
										.description("The email id of user who made the changes"),
								subsectionWithPath("_embedded.sw360:changeLogs[]changeTimestamp")
										.description("The date of the changelog"),
								subsectionWithPath("_embedded.sw360:changeLogs[]parentDocId")
										.description("The id of the parent document which caused this change")
										.optional(),
								subsectionWithPath("_embedded.sw360:changeLogs[]info").description(
										"Miscellaneous information like attachment filename, content type, parent doc operation")
										.optional(),
								subsectionWithPath("_embedded.sw360:changeLogs[]changes[]fieldName")
										.description("The name of the changed field").optional(),
								subsectionWithPath("_embedded.sw360:changeLogs[]changes[]fieldValueOld")
										.description("The old value of changed field").optional(),
								subsectionWithPath("_embedded.sw360:changeLogs[]changes[]fieldValueNew")
										.description("The new value of changed field").optional(),
								subsectionWithPath("_embedded.sw360:changeLogs[]changes")
										.description("An array of changes").optional(),
								subsectionWithPath("_embedded.sw360:changeLogs[]referenceDoc[]refDocId").description(
										"The id of the document created along with current changes like Attachments")
										.optional(),
								subsectionWithPath("_embedded.sw360:changeLogs[]referenceDoc[]refDocType")
										.description(
												"The type of the reference document. Possible values are " + docType)
										.optional(),
								subsectionWithPath("_embedded.sw360:changeLogs[]referenceDoc[]refDocOperation")
										.description("The type of the operation. Possible values are "
												+ Arrays.asList(Operation.values()))
										.optional(),
								subsectionWithPath("_embedded.sw360:changeLogs[]referenceDoc[]")
										.description("An array of refernce doc").optional(),
								subsectionWithPath("_embedded.sw360:changeLogs")
										.description("An array of <<resources-changelog, ChangeLog resources>>"),
								...
								fieldWithPath("page.totalElements")
										.description("Total number of all existing changelogs"),
