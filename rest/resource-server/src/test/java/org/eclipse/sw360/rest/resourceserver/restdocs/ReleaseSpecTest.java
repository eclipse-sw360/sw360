...
public class ReleaseSpecTest extends TestRestDocsSpecBase {
	...
	public void before() throws TException, IOException {
		...
		given(this.attachmentServiceMock.filterAttachmentsToRemove(any(), any(), any()))
				.willReturn(Collections.singleton(attachment));
		...
		given(this.releaseServiceMock.getUsingComponentsForRelease(eq(release.getId()), any()))
				.willReturn(usedByComponent);
		given(this.releaseServiceMock.deleteRelease(eq(release.getId()), any())).willReturn(RequestStatus.SUCCESS);
		given(this.releaseServiceMock.searchByExternalIds(eq(externalIds), any()))
				.willReturn((new HashSet<>(releaseList)));
		given(this.releaseServiceMock.convertToEmbeddedWithExternalIds(eq(release)))
				.willReturn(new Release("Angular", "2.3.0", component.getId()).setId(releaseId)
						.setExternalIds(Collections.singletonMap("mainline-id-component", "1432")));
		given(this.releaseServiceMock.convertToEmbeddedWithExternalIds(eq(release2)))
				.willReturn(new Release("Angular", "2.3.1", component.getId()).setId("3765276512")
						.setExternalIds(Collections.singletonMap("mainline-id-component", "4876")));
		when(this.releaseServiceMock.createRelease(any(), any()))
				.then(invocation -> new Release("Test Release", "1.0", component.getId()).setId("1234567890"));
		...
		given(this.licenseServiceMock.getLicenseById("Apache-2.0")).willReturn(new License("Apache 2.0 License")
				.setText("Dummy License Text").setShortname("Apache-2.0").setId(UUID.randomUUID().toString()));
		given(this.licenseServiceMock.getLicenseById("GPL-2.0-or-later"))
				.willReturn(new License("GNU General Public License 2.0").setText("GNU General Public License 2.0 Text")
		...
		releaseIdToRelationship1 = ImmutableMap.of(release2.getId(), ReleaseRelationship.DYNAMICALLY_LINKED,
				release3.getId(), ReleaseRelationship.CONTAINED);
	}

	@Test
	public void should_document_get_releases() throws Exception {
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		mockMvc.perform(get("/api/releases").header("Authorization", "Bearer " + accessToken).param("page", "0")
				.param("page_entries", "5").param("sort", "name,desc").accept(MediaTypes.HAL_JSON))
				.andExpect(status().isOk())
				.andDo(this.documentationHandler.document(
						requestParameters(parameterWithName("page").description("Page of release"),
	...
	public void should_document_get_release_all_details() throws Exception {
		...
		mockMvc.perform(get("/api/releases?allDetails=true")
				...
				.andExpect(status().isOk())
				.andDo(this.documentationHandler.document(
						links(linkWithRel("curies").description("The curies for documentation")),
						responseFields(
								subsectionWithPath("_embedded.sw360:releases.[]componentType")
										.description("The componentType of the release, possible values are "
								...
								subsectionWithPath("_embedded.sw360:releases.[]contributors")
								...
								subsectionWithPath("_embedded.sw360:releases.[]mainLicenseIds")
										.description("An array of all main licenses").optional(),
								subsectionWithPath("_embedded.sw360:releases.[]otherLicenseIds")
										.description("An array of all other licenses associated with the release")
										.optional(),
								...
								subsectionWithPath("_embedded.sw360:releases.[]_embedded.sw360:moderators")
										.description("An array of all release moderators with email"),
								subsectionWithPath("_embedded.sw360:releases.[]_embedded.sw360:attachments")
										.description("An array of all release attachments").optional(),
								subsectionWithPath("_embedded.sw360:releases.[]_embedded.sw360:cotsDetails")
										.description("An cotsDetails of the release").optional(),
								subsectionWithPath("_embedded.sw360:releases.[]_embedded.sw360:releaseIdToRelationship")
										.description("An linked release Id with relation").optional(),
								subsectionWithPath("_embedded.sw360:releases.[]_embedded.sw360:clearingInformation")
										.description("An Clearing Information of the release").optional(),
								subsectionWithPath("_embedded.sw360:releases.[]_links")
										.description("Self <<resources-index-links,Links>> to Release resource"),
								subsectionWithPath("_links")
										.description("<<resources-index-links,Links>> to other resources"))));
	}
				...
				.andDo(this.documentationHandler.document(
						...
						responseFields(
								...
								subsectionWithPath("_embedded.sw360:releases.[]version")
										.description("The version of the release"),
								subsectionWithPath("_embedded.sw360:releases.[]cpeId")
										.description("The cpeId of the release, optional"),
								subsectionWithPath("_embedded.sw360:releases.[]releaseDate")
										.description("The releaseDate of the release, optional"),
								subsectionWithPath("_embedded.sw360:releases")
										.description("An array of <<resources-releases, Releases resources>>"),
								subsectionWithPath("_links")
										.description("<<resources-index-links,Links>> to other resources"))));
	...
	public void should_document_get_release() throws Exception {
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		mockMvc.perform(get("/api/releases/" + release.getId()).header("Authorization", "Bearer " + accessToken)
				.accept(MediaTypes.HAL_JSON)).andExpect(status().isOk()).andDo(
						this.documentationHandler.document(
								links(linkWithRel("self").description("The <<resources-releases,Releases resource>>"),
										linkWithRel("sw360:component")
												.description("The link to the corresponding component"),
										linkWithRel("curies").description("The curies for documentation")),
								responseFields(fieldWithPath("name").description("The name of the release, optional"),
										...
										fieldWithPath("createdOn")
												.description("The creation date of the internal sw360 release"),
										fieldWithPath("componentType")
												.description("The componentType of the release, possible values are "
														+ Arrays.asList(ComponentType.values())),
										fieldWithPath("mainlineState")
												.description("the mainline state of the release, possible values are: "
														+ Arrays.asList(MainlineState.values())),
										fieldWithPath("sourceCodeDownloadurl")
												.description("the source code download url of the release"),
										fieldWithPath("binaryDownloadurl")
												.description("the binary download url of the release"),
										fieldWithPath("otherLicenseIds").description(
												"An array of all other licenses associated with the release"),
										...
										subsectionWithPath("_embedded.sw360:licenses").description(
												"An array of all main licenses with their fullName and link to their <<resources-license-get,License resource>>"),
										fieldWithPath("operatingSystems")
												.description("The OS on which the release operates"),
										fieldWithPath("softwarePlatforms")
												.description("The software platforms of the component"),
										subsectionWithPath("_embedded.sw360:moderators").description(
												"An array of all release moderators with email and link to their <<resources-user-get,User resource>>"),
										subsectionWithPath("_embedded.sw360:attachments").description(
												"An array of all release attachments and link to their <<resources-attachment-get,Attachment resource>>"),
										subsectionWithPath("_links")
												.description("<<resources-index-links,Links>> to other resources"))));
	}
	...
	public void should_document_delete_releases() throws Exception {
		...
		mockMvc.perform(delete("/api/releases/" + release.getId())
				...
				.andDo(this.documentationHandler.document(
						responseFields(fieldWithPath("[].resourceId").description("id of the deleted resource"),
	...
	public void should_document_get_usedbyresource_for_release() throws Exception {
		...
		mockMvc.perform(get("/api/releases/usedBy/" + release.getId())
				...
				.andDo(this.documentationHandler.document(responseFields(
						...
						subsectionWithPath("_embedded.sw360:components.[]componentType").description(
	...
	public void should_document_update_release() throws Exception {
		...
		release.setComponentType(ComponentType.OSS);
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		mockMvc.perform(patch("/api/releases/" + releaseId).contentType(MediaTypes.HAL_JSON)
		...
		mockMvc.perform(get("/api/releases/searchByExternalIds?mainline-id-component=1432&mainline-id-component=4876")
				...
				.andDo(this.documentationHandler.document(responseFields(
						...
						subsectionWithPath("_embedded.sw360:releases.[]version")
								.description("The version of the release"),
						subsectionWithPath("_embedded.sw360:releases.[]externalIds").description(
								"External Ids of the release. Return as 'Single String' when single value, or 'Array of String' when multi-values"),
						subsectionWithPath("_links")
								.description("<<resources-index-links,Links>> to other resources"))));
	}
	...
	public void should_document_trigger_fossology_process() throws Exception {
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		mockMvc.perform(get("/api/releases/" + release3.getId()
				+ "/triggerFossologyProcess?uploadDescription=uploadDescription&markFossologyProcessOutdated=false")
						.header("Authorization", "Bearer " + accessToken))
				.andExpect(status().isOk()).andDo(this.documentationHandler.document(responseFields(
	...
	public void should_document_check_fossology_process_status() throws Exception {
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		mockMvc.perform(get("/api/releases/" + release3.getId() + "/checkFossologyProcessStatus")
				.header("Authorization", "Bearer " + accessToken)).andExpect(status().isOk())
				.andDo(this.documentationHandler.document(responseFields(
						fieldWithPath("status").description("The status of triggered FOSSology, possible values are: "
								+ Arrays.asList(RequestStatus.SUCCESS, RequestStatus.FAILURE,
						...
						fieldWithPath("fossologyProcessInfo.externalTool")
								.description("The name of external tool ,possible values are: "
										+ Arrays.asList(ExternalTool.values())),
						fieldWithPath("fossologyProcessInfo.processStatus")
								.description("The status of process, possible values are: "
										+ Arrays.asList(ExternalToolProcessStatus.values())),
						...
						fieldWithPath("fossologyProcessInfo.processSteps[]stepName")
								.description("The name of step in FOSSology process, possible values are: "
										+ Arrays.asList("01_upload", "02_scan", "03_report")),
						fieldWithPath("fossologyProcessInfo.processSteps[]stepStatus")
								.description("The status of step, possible values are: "
										+ Arrays.asList(ExternalToolProcessStatus.DONE,
												ExternalToolProcessStatus.IN_WORK, ExternalToolProcessStatus.NEW)),
	...
	public void should_document_create_release() throws Exception {
		...
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		this.mockMvc
				.perform(post("/api/releases").contentType(MediaTypes.HAL_JSON)
						.content(this.objectMapper.writeValueAsString(release))
						.header("Authorization", "Bearer " + accessToken))
				.andExpect(status().isCreated()).andDo(
						this.documentationHandler.document(
								requestFields(fieldWithPath("version").description("The version of the new release"),
										fieldWithPath("componentId")
												.description("The componentId of the origin component")),
								responseFields(fieldWithPath("name").description("The name of the release, optional"),
										fieldWithPath("version").description("The version of the release"),
										subsectionWithPath("_links")
												.description("<<resources-index-links,Links>> to other resources"))));
	...
	public void should_document_delete_release_attachment() throws Exception {
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		mockMvc.perform(
				delete("/api/releases/" + release.getId() + "/attachments/" + attachment.getAttachmentContentId())
						.header("Authorization", "Bearer " + accessToken).accept(MediaTypes.HAL_JSON))
				.andExpect(status().isOk()).andDo(documentReleaseProperties());
	}
	...
	public void should_document_link_releases_to_release() throws Exception {
		...
		String accessToken = TestHelper.getAccessToken(mockMvc, testUserId, testUserPassword);
		mockMvc.perform(post("/api/releases/" + release.getId() + "/releases").contentType(MediaTypes.HAL_JSON)
	...
	private RestDocumentationResultHandler documentReleaseProperties() {
		return this.documentationHandler.document(
				...
				responseFields(fieldWithPath("name").description("The name of the release, optional"),
						...
						fieldWithPath("createdBy").description("Email of the release creator"),
						fieldWithPath("cpeId").description("CpeId of the release"),
						fieldWithPath("clearingState").description("The clearing of the release, possible values are "
								+ Arrays.asList(ClearingState.values())),
						fieldWithPath("cpeId").description("The CPE id"),
						fieldWithPath("releaseDate").description("The date of this release"),
						fieldWithPath("componentType")
