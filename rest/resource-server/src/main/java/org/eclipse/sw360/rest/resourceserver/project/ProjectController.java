...
public class ProjectController implements RepresentationModelProcessor<RepositoryLinksResource> {
	...
	public ResponseEntity<CollectionModel<EntityModel<Project>>> getProjectsForUser(Pageable pageable,
			@RequestParam(value = "name", required = false) String name,
			@RequestParam(value = "type", required = false) String projectType,
			@RequestParam(value = "group", required = false) String group,
			@RequestParam(value = "tag", required = false) String tag,
			@RequestParam(value = "allDetails", required = false) boolean allDetails,
			@RequestParam(value = "luceneSearch", required = false) boolean luceneSearch, HttpServletRequest request)
	...
	public ResponseEntity<EntityModel<Project>> getProject(@PathVariable("id") String id) throws TException {
		User sw360User = restControllerHelper.getSw360UserFromAuthentication();
	...
	public ResponseEntity linkReleases(@PathVariable("id") String id, @RequestBody Object releasesInRequestBody)
			throws URISyntaxException, TException {
	...
	public ResponseEntity<CollectionModel<EntityModel<Release>>> getProjectReleases(Pageable pageable,
			@PathVariable("id") String id, @RequestParam(value = "transitive", required = false) String transitive,
	...
	public ResponseEntity<CollectionModel<EntityModel<Release>>> getProjectsReleases(Pageable pageable,
			@RequestBody List<String> projectIds,
			@RequestParam(value = "transitive", required = false) String transitive,
			@RequestParam(value = "clearingState", required = false) String clState, HttpServletRequest request)
			throws TException, URISyntaxException, PaginationParameterException, ResourceClassNotFoundException {
	...
	public ResponseEntity<CollectionModel<EntityModel<Release>>> getECCsOfReleases(@PathVariable("id") String id,
	...
	public ResponseEntity<CollectionModel<EntityModel<VulnerabilityDTO>>> getVulnerabilitiesOfReleases(
			Pageable pageable, @PathVariable("id") String id,
			...
			@RequestParam(value = "externalId") Optional<String> externalId, HttpServletRequest request)
		...
		List<String> priorityList = priority.isPresent()
				? Lists.newArrayList(priority.get().split(","))
				: Lists.newArrayList();
	...
	public ResponseEntity<EntityModel<ProjectReleaseRelationship>> patchProjectReleaseUsage(
		...
		EntityModel<ProjectReleaseRelationship> updatedProjectReleaseRelationshipResource = EntityModel
				.of(updatedProjectReleaseRelationship);
	...
	public ProjectVulnerabilityRating updateProjectVulnerabilityRatingFromRequest(
		...
		ProjectVulnerabilityRating projectVulnerabilityRating = projectVulnerabilityRatings
				.orElse(new ProjectVulnerabilityRating().setProjectId(projectId)
	...
	public ResponseEntity<CollectionModel<EntityModel<License>>> getLicensesOfReleases(@PathVariable("id") String id)
			throws TException {
		final User sw360User = restControllerHelper.getSw360UserFromAuthentication();
	...
	public void downloadLicenseInfo(@PathVariable("id") String id,
			@RequestParam("generatorClassName") String generatorClassName, @RequestParam("variant") String variant,
			@RequestParam(value = "externalIds", required = false) String externalIds,
			@RequestParam(value = "template", required = false) String template, HttpServletResponse response)
		...
		final String filename = String.format("%s-%s%s-%s.%s",
				...
				projectName, StringUtils.isBlank(projectVersion) ? "" : "-" + projectVersion, timestamp,
	...
	public ResponseEntity<CollectionModel<EntityModel<Attachment>>> getProjectAttachments(@PathVariable("id") String id)
			throws TException {
		final User sw360User = restControllerHelper.getSw360UserFromAuthentication();
		final Project sw360Project = projectService.getProjectForUserById(id, sw360User);
		final CollectionModel<EntityModel<Attachment>> resources = attachmentService
				.getResourcesFromList(sw360Project.getAttachments());
	...
	public void downloadAttachmentFromProject(@PathVariable("projectId") String projectId,
	...
	public void downloadClearingReports(@PathVariable("projectId") String projectId, HttpServletResponse response)
			throws TException {
		final User sw360User = restControllerHelper.getSw360UserFromAuthentication();
		final Project project = projectService.getProjectForUserById(projectId, sw360User);
	...
	public ResponseEntity<EntityModel<Project>> patchProject(@PathVariable("id") String id,
			@RequestBody Map<String, Object> reqBodyMap) throws TException {
		User user = restControllerHelper.getSw360UserFromAuthentication();
		Project sw360Project = projectService.getProjectForUserById(id, user);
		Project updateProject = convertToProject(reqBodyMap);
	...
	public ResponseEntity<CollectionModel<EntityModel<Project>>> getUsedByProjectDetails(@PathVariable("id") String id)
			throws TException {
		User user = restControllerHelper.getSw360UserFromAuthentication();
		// Project sw360Project = projectService.getProjectForUserById(id, user);
