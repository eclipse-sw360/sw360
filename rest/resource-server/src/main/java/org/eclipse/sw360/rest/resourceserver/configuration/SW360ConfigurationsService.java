...
public class SW360ConfigurationsService {
    ...
    public Map<String, String> getSW360ConfigFromProperties() {
        ...
        configFromProperties.put(SW360ConfigKeys.ENABLE_FLEXIBLE_PROJECT_RELEASE_RELATIONSHIP, String.valueOf(SW360Constants.ENABLE_FLEXIBLE_PROJECT_RELEASE_RELATIONSHIP));
