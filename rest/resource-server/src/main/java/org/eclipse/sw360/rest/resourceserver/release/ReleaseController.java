...
public class ReleaseController implements RepresentationModelProcessor<RepositoryLinksResource> {
	...
	private static final ImmutableMap<Release._Fields, String> mapOfFieldsTobeEmbedded = ImmutableMap.of(
			Release._Fields.MODERATORS, "sw360:moderators", Release._Fields.ATTACHMENTS, "sw360:attachments",
			Release._Fields.COTS_DETAILS, "sw360:cotsDetails", Release._Fields.RELEASE_ID_TO_RELATIONSHIP,
			"sw360:releaseIdToRelationship", Release._Fields.CLEARING_INFORMATION, "sw360:clearingInformation");
	private static final ImmutableMap<Release._Fields, String[]> mapOfBackwardCompatible_Field_OldFieldNames_NewFieldNames = ImmutableMap.<Release._Fields, String[]>builder()
			.put(Release._Fields.SOURCE_CODE_DOWNLOADURL, new String[]{"downloadurl", "sourceCodeDownloadurl"}).build();
	...
	public ResponseEntity<CollectionModel<EntityModel>> getReleasesForUser(Pageable pageable,
	...
	public ResponseEntity<EntityModel> getRelease(@PathVariable("id") String id) throws TException {
		User sw360User = restControllerHelper.getSw360UserFromAuthentication();
	...
	public ResponseEntity<List<MultiStatus>> deleteReleases(@PathVariable("ids") List<String> idsToDelete)
			throws TException {
	...
	public ResponseEntity<EntityModel<Release>> patchRelease(@PathVariable("id") String id,
	...
	public ResponseEntity<EntityModel<Release>> createRelease(@RequestBody Map<String, Object> reqBodyMap)
	...
	public ResponseEntity<CollectionModel<EntityModel<Attachment>>> getReleaseAttachments(@PathVariable("id") String id)
			throws TException {
		...
		final CollectionModel<EntityModel<Attachment>> resources = attachmentService
				.getResourcesFromList(sw360Release.getAttachments());
	...
	public void downloadAttachmentFromRelease(@PathVariable("releaseId") String releaseId,
	...
	public ResponseEntity<HalResource<Release>> deleteAttachmentsFromRelease(
			@PathVariable("releaseId") String releaseId, @PathVariable("attachmentIds") List<String> attachmentIds)
			throws TException {
		User user = restControllerHelper.getSw360UserFromAuthentication();
	...
	public ResponseEntity linkReleases(@PathVariable("id") String id,
