...
public class SW360ReportController implements RepresentationModelProcessor<RepositoryLinksResource> {
    ...
    public void getProjectReport(
            ...
            @Parameter(description = "Module name.", schema = @Schema(allowableValues = {SW360Constants.PROJECTS, SW360Constants.COMPONENTS}))
        ...
        try {
            if (validateMimeType(mimeType)) {
                ...
                case SW360Constants.PROJECT_RELEASE_SPREADSHEET_WITH_ECCINFO:
                    getProjectReleaseWithEccSpreadSheet(response, sw360User, module, projectId);
                    break;
                default:
                    break;
                }
        ...
        try {
            ...
            switch (module) {
                ...
                case SW360Constants.LICENSES:
                    ...
                    break;
                case SW360Constants.PROJECT_RELEASE_SPREADSHEET_WITH_ECCINFO:
                    buffer = sw360ReportService.getProjectReleaseSpreadSheetWithEcc(user, projectId);
                    break;
                default:
                    break;
            }
            ...
            String fileName;
            if(module.equals(SW360Constants.PROJECTS) || module.equals(SW360Constants.PROJECT_RELEASE_SPREADSHEET_WITH_ECCINFO)) {
    ...
    private void getProjectReleaseWithEccSpreadSheet(HttpServletResponse response, User sw360User, String module,
        ...
        try {
            downloadExcelReport(false, response, sw360User, module, projectId);
        } catch (Exception e) {
            throw new TException(e.getMessage());
        }
    }
