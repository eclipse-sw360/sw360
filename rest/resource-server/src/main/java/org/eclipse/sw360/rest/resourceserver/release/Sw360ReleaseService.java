...
public class Sw360ReleaseService implements AwareOfRestServices<Release> {
	...
	public Release createRelease(Release release, User sw360User) throws TException {
		...
		if (documentRequestSummary.getRequestStatus() == AddDocumentRequestStatus.SUCCESS) {
			...
			throw new DataIntegrityViolationException(
					"sw360 release with name '" + SW360Utils.printName(release) + "' already exists.");
	...
	public ExternalToolProcess fossologyProcess(String releaseId, User sw360User, String uploadDescription)
			throws TException {
	...
	public void executeFossologyProcess(User user, Sw360AttachmentService attachmentService,
			...
			String uploadDescription) throws TException, IOException {
