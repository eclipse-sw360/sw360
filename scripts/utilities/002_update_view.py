...
doc_id = "document_id"
nested_field_key = ["key1", "nestedKey2", "nestedKey3"]
new_value = "new_value"
...
def run():
    ...
    resultFile = open('002_utilities.log', 'w')
    json.dump(log, resultFile, indent = 4)
    resultFile.close()

    print '\n'
    print '------------------------------------------'
    print 'Please check log file "002_utilities.log" in this directory for details'
    print '------------------------------------------'
