...
def run():
    logFile = open('050_migrate_clearing_request_status.log', 'w')
    ...
    logFile.close()
    print '------------------------------------------'
    print 'Please check log file "050_migrate_clearing_request_status.log" in this directory for details'
    print '------------------------------------------'
