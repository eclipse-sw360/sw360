...
get_projects_with_releaseIdToUsage_field_query = {"selector": {"type": {"$eq": "project"}, releaseIdToUsageFieldName: {"$exists": True}}, "limit": 100000}
...
def applyTransferData(project, log):
    updatedDocId = {}
...
def run():
    ...
    for project in project_with_releaseIdToUsage_field:
        ...
        try:
            ...
            project[newFieldName] = json.dumps(dependency_network, separators=(',', ':'))

            applyTransferData(project, log)
        except:
