...
#
# This script removes old design document for license obligation
# -----------------------------------------------------------------------------
...
doc_id = "_design/LicenseObligation"
...
def run():
    ...
    resultFile = open('029_remove_old_licenseobligation_view.log', 'w')
    json.dump(log, resultFile, indent = 4)
    resultFile.close()

    print '\n'
    print '------------------------------------------'
    print 'Please check log file "029_remove_old_licenseobligation_view.log" in this directory for details'
    print '------------------------------------------'
