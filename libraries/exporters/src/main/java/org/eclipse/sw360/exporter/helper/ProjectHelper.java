...
public class ProjectHelper implements ExporterHelper<Project> {
	...
	public ProjectHelper(ProjectService.Iface projectClient, User user, boolean extendedByReleases,
		...
		if (project.isSet(field)) {
			...
			switch (field) {
				case RELEASE_ID_TO_USAGE :
					...
					row.add(fieldValueAsString(putAccessibleReleaseNamesInMap(project.releaseIdToUsage,
							getReleases(project), user, inaccessibleRelationship)));
					break;
				case LINKED_PROJECTS :
					row.add(fieldValueAsString(putProjectNamesInMap(project.getLinkedProjects(),
