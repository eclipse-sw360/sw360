...
public class ComponentAttachmentCSVRecordBuilderTest {
	...
	public void testFillAttachment() throws Exception {
		...
		attachment.setFilename(fileName).setAttachmentContentId(attachmentContentID).setCreatedComment(comment)
				.setAttachmentType(attachmentType).setCreatedBy(createdBy).setCreatedOn(createdOn);
