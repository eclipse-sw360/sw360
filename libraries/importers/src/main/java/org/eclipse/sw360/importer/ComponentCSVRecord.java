...
public class ComponentCSVRecord extends ComponentAwareCSVRecord {
	...
	ComponentCSVRecord(String componentName, String componentDescription, String componentCreatedOn,
			String componentType, String componentCreatedBy, String componentSubscribers, String categories,
			String softwarePlatforms, String componentHomePage, String componentMailingList, String componentWiki,
			String componentBlog, String componentWikipedia, String componentOpenHub, String releaseName,
			String releaseVersion, String releaseDate, String CPEId, String releaseCreatedOn, String releaseCreatedBy,
			String releaseRepositoryURL, String releaseRepositoryType, String releaseMainlineState,
			String releaseClearingState, String releaseContributors, String releaseModerators,
			String releaseSubscribers, String releaseLanguages, String releaseOperatingSystems,
			String releaseMainLicenseIds, String releaseSourceCodeDownloadurl, String releaseBinaryDownloadurl,
			String vendorName, String vendorShortname, String vendorUrl, String cIExternalSupplierID,
			String cIAdditionalInfo, String cIEvaluated, String cIProcStart, String cIRequestId, String cIScanned,
			String cIClearingStandard, String cIComment, String cIExternalUrl, Boolean cIBinariesOriginalFromCommunity,
			Boolean cIBinariesSelfMade, Boolean cIComponentLicenseInformation, Boolean cISourceCodeDelivery,
			Boolean cISourceCodeOriginalFromCommunity, Boolean cISourceCodeToolMade, Boolean cISourceCodeSelfMade,
			Boolean cIScreenshotOfWebSite, Boolean cIFinalizedLicenseScanReport, Boolean cILicenseScanReportResult,
			Boolean cILegalEvaluation, Boolean cILicenseAgreement, Boolean cIComponentClearingReport,
			Integer cICountOfSecurityVn, String eccStatus, String eccAL, String eccECCN, String eccMaterialIndexNumber,
			String eccComment, String eccAssessorContactPerson, String eccAssessorDepartment,
			String eccAssessmentDate) {
	...
	public boolean isSetAttachmentContent() {
		return isValidUrl(releaseSourceCodeDownloadurl);
	}
	...
	public Release getRelease(String vendorId, String componentId, List<AttachmentContent> attachments) {
		...
		if (attachments != null) {
			for (AttachmentContent attachmentContent : attachments) {
				...
				release.addToAttachments(new Attachment().setAttachmentContentId(attachmentContentId)
						.setCreatedOn(SW360Utils.getCreatedOn()).setCreatedBy(releaseCreatedBy)
						.setAttachmentType(AttachmentType.SOURCE).setFilename(attachmentContent.getFilename()));
			}
		}
		return release;
	}
	...
	public Repository getRepository() {
		...
		if (!isNullOrEmpty(releaseRepositoryType)) {
			final RepositoryType repositoryType = ThriftEnumUtils.stringToEnum(releaseRepositoryType,
	...
	public List<AttachmentContent> getAttachmentContents() {
		...
		if (CommonUtils.isValidUrl(releaseSourceCodeDownloadurl)) {
			...
			attachments.add(new AttachmentContent().setFilename(fileName).setRemoteUrl(releaseSourceCodeDownloadurl)
					.setOnlyRemote(true));
		}
		return attachments;
	}
	...
	public String toString() {
		return "ComponentCSVRecord{" + "componentName='" + componentName + '\'' + ", componentDescription='"
				+ componentDescription + '\'' + ", componentCreatedOn='" + componentCreatedOn + '\''
				+ ", componentType='" + componentType + '\'' + ", componentCreatedBy='" + componentCreatedBy + '\''
				+ ", componentSubscribers='" + componentSubscribers + '\'' + ", categories='" + categories + '\''
				+ ", softwarePlatforms='" + softwarePlatforms + '\'' + ", componentHomePage='" + componentHomePage
				+ '\'' + ", componentMailingList='" + componentMailingList + '\'' + ", componentWiki='" + componentWiki
				+ '\'' + ", componentBlog='" + componentBlog + '\'' + ", componentWikipedia='" + componentWikipedia
				+ '\'' + ", componentOpenHub='" + componentOpenHub + '\'' + ", releaseName='" + releaseName + '\''
				+ ", releaseVersion='" + releaseVersion + '\'' + ", releaseDate='" + releaseDate + '\'' + ", CPEId='"
				+ CPEId + '\'' + ", releaseCreatedOn='" + releaseCreatedOn + '\'' + ", releaseCreatedBy='"
				+ releaseCreatedBy + '\'' + ", releaseRepositoryURL='" + releaseRepositoryURL + '\''
				+ ", releaseRepositoryType='" + releaseRepositoryType + '\'' + ", releaseMainlineState='"
				+ releaseMainlineState + '\'' + ", releaseClearingState='" + releaseClearingState + '\''
				+ ", releaseContributors='" + releaseContributors + '\'' + ", releaseModerators='" + releaseModerators
				+ '\'' + ", releaseSubscribers='" + releaseSubscribers + '\'' + ", releaseLanguages='"
				+ releaseLanguages + '\'' + ", releaseOperatingSystems='" + releaseOperatingSystems + '\''
				+ ", releaseMainLicenseIds='" + releaseMainLicenseIds + '\'' + ", releaseSourceCodeDownloadurl='"
				+ releaseSourceCodeDownloadurl + '\'' + ", releaseBinaryDownloadurl='" + releaseBinaryDownloadurl + '\''
				+ ", vendorName='" + vendorName + '\'' + ", vendorShortname='" + vendorShortname + '\''
				+ ", vendorUrl='" + vendorUrl + '\'' + ", cIExternalSupplierID='" + cIExternalSupplierID + '\''
				+ ", cIAdditionalInfo='" + cIAdditionalInfo + '\'' + ", cIEvaluated='" + cIEvaluated + '\''
				+ ", cIProcStart='" + cIProcStart + '\'' + ", cIRequestId='" + cIRequestId + '\'' + ", cIScanned='"
				+ cIScanned + '\'' + ", cIClearingStandard='" + cIClearingStandard + '\'' + ", cIComment='" + cIComment
				+ '\'' + ", cIExternalUrl='" + cIExternalUrl + '\'' + ", cIBinariesOriginalFromCommunity="
				+ cIBinariesOriginalFromCommunity + ", cIBinariesSelfMade=" + cIBinariesSelfMade
				+ ", cIComponentLicenseInformation=" + cIComponentLicenseInformation + ", cISourceCodeDelivery="
				+ cISourceCodeDelivery + ", cISourceCodeOriginalFromCommunity=" + cISourceCodeOriginalFromCommunity
				+ ", cISourceCodeToolMade=" + cISourceCodeToolMade + ", cISourceCodeSelfMade=" + cISourceCodeSelfMade
				+ ", cIScreenshotOfWebSite=" + cIScreenshotOfWebSite + ", cIFinalizedLicenseScanReport="
				+ cIFinalizedLicenseScanReport + ", cILicenseScanReportResult=" + cILicenseScanReportResult
				+ ", cILegalEvaluation=" + cILegalEvaluation + ", cILicenseAgreement=" + cILicenseAgreement
				+ ", cIComponentClearingReport=" + cIComponentClearingReport + ", cICountOfSecurityVn="
				+ cICountOfSecurityVn + ", eccStatus='" + eccStatus + '\'' + ", eccAL='" + eccAL + '\'' + ", eccECCN='"
				+ eccECCN + '\'' + ", eccMaterialIndexNumber='" + eccMaterialIndexNumber + '\'' + ", eccComment='"
				+ eccComment + '\'' + ", eccAssessorContactPerson='" + eccAssessorContactPerson + '\''
				+ ", eccAssessorDepartment='" + eccAssessorDepartment + '\'' + ", eccAssessmentDate='"
				+ eccAssessmentDate + '\'' + '}';
	}
}
