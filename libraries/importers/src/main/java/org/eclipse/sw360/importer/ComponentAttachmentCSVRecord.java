...
public class ComponentAttachmentCSVRecord extends ComponentAwareCSVRecord {
	...
	public ComponentAttachmentCSVRecord(String componentName, String releaseName, String releaseVersion,
			String attachmentContentId, String filename, String attachmentType, String comment, String createdOn,
			String createdBy) {
	...
	public Attachment getAttachment() {
		final Attachment attachment = new Attachment().setAttachmentContentId(attachmentContentId)
				.setFilename(filename);

		if (!isNullOrEmpty(attachmentType)) {
			final AttachmentType attachmentTypeCandidate = ThriftEnumUtils.stringToEnum(attachmentType,
					AttachmentType.class);
			if (attachmentTypeCandidate != null)
				attachment.setAttachmentType(attachmentTypeCandidate);
		}

		attachment.setCreatedComment(nullToEmpty(comment)).setCreatedOn(nullToEmpty(createdOn))
