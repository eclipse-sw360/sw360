...
public class WhenComputeVisibility extends Stage<WhenComputeVisibility> {
	...
	public WhenComputeVisibility the_visibility_is_computed_for_department_$_and_user_group_$(@Quoted String department,
			@TEnumToString UserGroup userGroup) {
	...
	public WhenComputeVisibility the_visibility_is_computed_for_the_wrong_department_and_the_user_$(
			@Quoted String mail) {
