...
public class MapperFactoryTest {
	...
	public void setUp() throws Exception {
		// Prepare mapper
		MapperFactory factory = new MapperFactory(ImmutableList.<Class<?>>of(TestObject.class),
				Collections.<Class<?>>emptyList(), Maps.newHashMap());
	...
	public void testNullValues() throws Exception {
		// Null _id and _rev should not be serialized, as they are not accepted by
		// CouchDB
		object.unsetId();
