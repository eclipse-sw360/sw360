...
public abstract class DocumentWrapperTest<W extends DocumentWrapper<C>, C extends TBase<C, F>, F extends Enum<F> & TFieldIdEnum>
		extends
			TestCase {
	private static final ImmutableList<String> NOT_COPIED_FIELDS = ImmutableList.of("id", "revision");

	protected void assertTFields(C source, W attachmentWrapper, Class<W> wrapperClass, Class<F> fieldClass)
