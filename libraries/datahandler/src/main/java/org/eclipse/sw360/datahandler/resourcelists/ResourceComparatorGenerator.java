...
public class ResourceComparatorGenerator<T> {
	...
	private static Map<Component._Fields, Comparator<Component>> generateComponentMap() {
		...
		componentMap.put(Component._Fields.NAME,
				Comparator.comparing(Component::getName, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		componentMap.put(Component._Fields.CREATED_ON,
				Comparator.comparing(Component::getCreatedOn, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		componentMap.put(Component._Fields.CREATED_BY,
				Comparator.comparing(Component::getCreatedBy, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		componentMap.put(Component._Fields.COMPONENT_TYPE,
				Comparator.comparing(c -> Optional.ofNullable(c.getComponentType()).map(Object::toString).orElse(null),
	...
	private static Map<Project._Fields, Comparator<Project>> generateProjectMap() {
		...
		projectMap.put(Project._Fields.NAME,
				Comparator.comparing(Project::getName, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		projectMap.put(Project._Fields.CREATED_ON,
				Comparator.comparing(Project::getCreatedOn, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		projectMap.put(Project._Fields.CREATED_BY,
				Comparator.comparing(Project::getCreatedBy, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		projectMap.put(Project._Fields.CLEARING_STATE,
				Comparator.comparing(p -> Optional.ofNullable(p.getClearingState()).map(Object::toString).orElse(null),
						Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		projectMap.put(Project._Fields.PROJECT_TYPE,
				Comparator.comparing(p -> Optional.ofNullable(p.getProjectType()).map(Object::toString).orElse(null),
						Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
	...
	private static Map<SearchResult._Fields, Comparator<SearchResult>> generateSearchResultMap() {
		...
		searchResultMap.put(SearchResult._Fields.NAME,
				Comparator.comparing(SearchResult::getName, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		searchResultMap.put(SearchResult._Fields.TYPE,
				Comparator.comparing(SearchResult::getType, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
	...
	private static Map<ChangeLogs._Fields, Comparator<ChangeLogs>> generateChangeLogMap() {
		...
		changeLogMap.put(ChangeLogs._Fields.CHANGE_TIMESTAMP, Comparator.comparing(ChangeLogs::getChangeTimestamp,
				Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		changeLogMap.put(ChangeLogs._Fields.USER_EDITED,
				Comparator.comparing(ChangeLogs::getUserEdited, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
	...
	private static Map<VulnerabilityDTO._Fields, Comparator<VulnerabilityDTO>> generateVulDtoMap() {
		...
		vulDTOMap.put(VulnerabilityDTO._Fields.EXTERNAL_ID, Comparator.comparing(VulnerabilityDTO::getExternalId,
				Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		vulDTOMap.put(VulnerabilityDTO._Fields.TITLE,
				Comparator.comparing(VulnerabilityDTO::getTitle, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		vulDTOMap.put(VulnerabilityDTO._Fields.PRIORITY, Comparator.comparing(VulnerabilityDTO::getPriority,
				Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
		vulDTOMap.put(VulnerabilityDTO._Fields.PROJECT_RELEVANCE, Comparator.comparing(
				VulnerabilityDTO::getProjectRelevance, Comparator.nullsFirst(String.CASE_INSENSITIVE_ORDER)));
	...
	public Comparator<T> generateComparator(String type, List<String> properties)
	...
	public Comparator<T> generateComparatorWithFields(String type, List<Component._Fields> fields)
			throws ResourceClassNotFoundException {
		switch (type) {
			case SW360Constants.TYPE_COMPONENT :
	...
	public Comparator<T> generateProjectComparatorWithFields(String type, List<Project._Fields> fields)
			throws ResourceClassNotFoundException {
		switch (type) {
			case SW360Constants.TYPE_PROJECT :
	...
	public Comparator<T> generateReleaseComparatorWithFields(String type, List<Release._Fields> fields)
			throws ResourceClassNotFoundException {
		switch (type) {
			case SW360Constants.TYPE_RELEASE :
	...
	public Comparator<T> generateSearchResultComparatorWithFields(String type, List<SearchResult._Fields> fields)
			throws ResourceClassNotFoundException {
		switch (type) {
			case SW360Constants.TYPE_SEARCHRESULT :
	...
	public Comparator<T> generateChangeLogComparatorWithFields(String type, List<ChangeLogs._Fields> fields)
			throws ResourceClassNotFoundException {
		switch (type) {
			case SW360Constants.TYPE_CHANGELOG :
	...
	public Comparator<T> generateVulDTOComparatorWithFields(String type, List<VulnerabilityDTO._Fields> fields)
			throws ResourceClassNotFoundException {
		switch (type) {
			case SW360Constants.TYPE_VULNERABILITYDTO :
