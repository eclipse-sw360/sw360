...
public class PermissionUtils {
	...
	static {
		...
		IS_ADMIN_PRIVATE_ACCESS_ENABLED = Boolean.parseBoolean(System.getProperty("RunPrivateProjectAccessTest",
				props.getProperty("admin.private.project.access.enabled", "false")));
	}
