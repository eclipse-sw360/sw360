...
public class SW360Assert {
	...
	public static <T> void assertIds(Collection<T> collection, Function<? super T, Boolean> idSetExtractor)
	...
	public static <T> void assertIdsUnset(Collection<T> collection, Function<? super T, Boolean> idSetExtractor)
			throws SW360Exception {
