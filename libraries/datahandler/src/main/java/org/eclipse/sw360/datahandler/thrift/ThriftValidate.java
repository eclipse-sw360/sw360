...
/**
 * Utility class to validate the data before inserting it in the database. In
 * particular, in ensure the that the type is set correctly on the object (for
 * easier parsing)
 *
...
public class ThriftValidate {
	...
	public static void prepareUser(User user) throws SW360Exception {
		...
		// guarantee that `CommentMadeDuringModerationRequest` is never stored in the
		// database as this is intended to be a transient field
