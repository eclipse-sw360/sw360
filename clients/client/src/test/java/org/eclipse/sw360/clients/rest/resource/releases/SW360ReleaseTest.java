...
public class SW360ReleaseTest extends SW360ResourcesTestUtils<SW360Release> {
	...
	public SW360Release prepareItem() {
		...
		sparseAttachmentSet
				.add(new SW360SparseAttachment().setFilename("").setAttachmentType(SW360AttachmentType.SOURCE));
	...
	private static SW360SparseAttachment makeSparseAttachment(String test) {
		return new SW360SparseAttachment().setAttachmentType(SW360AttachmentType.SOURCE).setFilename(test);
	}
	...
	public void testReleaseMergeWithPrecedenceHasAttachment() {
		...
		sw360Release2.getEmbedded().setAttachments(Collections.singleton(sw360SparseAttachment));
	...
	public void testReleaseMergeWithPrecedenceHasNoAttachment() {
		...
		sw360Release1.getEmbedded().setAttachments(Collections.singleton(sw360SparseAttachment));
	...
	public void testReleaseMergeWithBothHaveDifferentAttachment() {
		...
		sw360Release1.getEmbedded().setAttachments(Collections.singleton(sw360SparseAttachment1));

		final SW360SparseAttachment sw360SparseAttachment2 = makeSparseAttachment("test_2");

		sw360Release2.getEmbedded().setAttachments(Collections.singleton(sw360SparseAttachment2));
