...
public class MultiStatusResponseTest {
	...
	private static MultiStatusResponse fromJson(String file) throws IOException {
		try (InputStream stream = MultiStatusResponseTest.class.getResourceAsStream("/__files/" + file + ".json")) {
	...
	public void testEquals() {
		EqualsVerifier.forClass(MultiStatusResponse.class).withNonnullFields("responses").verify();
	}
	...
	public void testFromJsonInvalidStatusCodes() throws IOException {
		String json = "[{\"resourceId\": \"res-1234\"," + "\"status\": \"invalidStatus\"}]";
	...
	public void testFromJsonMissingResourceId() throws IOException {
		String json = "[{\"noResourceId\": \"res-undefined\"," + "\"status\": 200}]";
		InputStream stream = new ByteArrayInputStream(json.getBytes(StandardCharsets.UTF_8));
