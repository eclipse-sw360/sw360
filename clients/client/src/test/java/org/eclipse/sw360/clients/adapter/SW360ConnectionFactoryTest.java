...
public class SW360ConnectionFactoryTest {
	 ...
	 */
	private static final SW360ClientConfig CONFIG = SW360ClientConfig.createConfig("restURL", "authURL", "user",
			"password", "clientId", "clientPassword", "token", mock(HttpClient.class), mock(ObjectMapper.class));
	...
	/**
	 * Invokes the test factory with the test configuration to create a new (test)
	 * SW360 connection.
	 *
	...
	/**
	 * Checks whether a correct synchronous adapter for an entity type is returned.
	 *
	 * @param syncAdapter
	 *            the synchronous adapter
	 * @param asyncAdapter
	 *            the corresponding asynchronous adapter
	 */
	...
	public void testReleaseAdapter() {
		...
		SW360ReleaseClientAdapterAsyncImpl releaseAdapterAsync = (SW360ReleaseClientAdapterAsyncImpl) connection
