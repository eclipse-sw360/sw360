...
public class AccessTokenTest {
	...
	public void testTokenIsAddedToRequestBuilder() {
		...
		when(builder.header(HttpConstants.HEADER_AUTHORIZATION, AUTH_HEADER_VALUE)).thenReturn(builderResult);
	...
	public void testEquals() {
		EqualsVerifier.forClass(AccessToken.class).withNonnullFields("token").verify();
	}
}