...
import org.eclipse.sw360.clients.rest.resource.projects.SW360ProjectEmbedded;
import org.eclipse.sw360.clients.rest.resource.projects.SW360ProjectListEmbedded;
import org.eclipse.sw360.clients.rest.resource.projects.SW360ProjectReleaseRelationship;
...
/**
 * Test class for the equals() implementations of various resource classes that
 * do not have their own test class.
 */
public class SW360ResourcesEqualsTest {
	private static void testEqualsWithInheritance(Class<?> resourceClass) {
		EqualsVerifier.forClass(resourceClass).withRedefinedSuperclass().suppress(Warning.NONFINAL_FIELDS).verify();
	}
	...
	public void testEqualsLicenseListEmbedded() {
		EqualsVerifier.forClass(SW360LicenseListEmbedded.class).withRedefinedSubclass(SW360ReleaseEmbedded.class)
	...
	public void testEqualsComponentEmbedded() {
		EqualsVerifier.forClass(SW360ComponentEmbedded.class).suppress(Warning.NONFINAL_FIELDS).verify();
	}

	@Test
	public void testEqualsComponentListEmbedded() {
		EqualsVerifier.forClass(SW360ComponentListEmbedded.class).suppress(Warning.NONFINAL_FIELDS).verify();
	}

	@Test
	public void testEqualsProjectEmbedded() {
		EqualsVerifier.forClass(SW360ProjectEmbedded.class).suppress(Warning.NONFINAL_FIELDS).verify();
	}

	@Test
	public void testEqualsProjectListEmbedded() {
		EqualsVerifier.forClass(SW360ProjectListEmbedded.class).suppress(Warning.NONFINAL_FIELDS).verify();
	}

	@Test
	public void testEqualsProjectReleaseRelationship() {
		EqualsVerifier.forClass(SW360ProjectReleaseRelationship.class).suppress(Warning.NONFINAL_FIELDS).verify();
	}

	@Test
	public void testEqualsReleaseListEmbedded() {
		EqualsVerifier.forClass(SW360ReleaseListEmbedded.class).suppress(Warning.NONFINAL_FIELDS).verify();
	}

	@Test
	public void testEqualsLinkObject() {
		EqualsVerifier.forClass(LinkObjects.class).usingGetClass().suppress(Warning.NONFINAL_FIELDS).verify();
	}

	@Test
	public void testEqualsReleaseLinkObjects() {
		EqualsVerifier.forClass(SW360ReleaseLinkObjects.class).withRedefinedSuperclass()
				.suppress(Warning.NONFINAL_FIELDS).verify();
	}
}