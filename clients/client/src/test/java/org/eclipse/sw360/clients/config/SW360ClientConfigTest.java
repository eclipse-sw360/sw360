...
public class SW360ClientConfigTest {
	...
	public void testNullRestUrlThrows() {
		SW360ClientConfig.createConfig(null, AUTH_URL, USER, PASSWORD, CLIENT_ID, CLIENT_PASS, USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testEmptyRestUrlThrows() {
		SW360ClientConfig.createConfig("", AUTH_URL, USER, PASSWORD, CLIENT_ID, CLIENT_PASS, USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testInvalidResUrlThrows() {
		SW360ClientConfig.createConfig("this is not a valid URL?!", AUTH_URL, USER, PASSWORD, CLIENT_ID, CLIENT_PASS,
				USER_TOKEN, httpClient, mapper);
	}

	@Test(expected = NullPointerException.class)
	public void testNullAuthUrlThrows() {
		SW360ClientConfig.createConfig(REST_URL, null, USER, PASSWORD, CLIENT_ID, CLIENT_PASS, USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testEmptyAuthUrlThrows() {
		SW360ClientConfig.createConfig(REST_URL, "", USER, PASSWORD, CLIENT_ID, CLIENT_PASS, USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = NullPointerException.class)
	public void testNullUserThrows() {
		SW360ClientConfig.createConfig(REST_URL, AUTH_URL, null, PASSWORD, CLIENT_ID, CLIENT_PASS, USER_TOKEN,
				httpClient, mapper);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testEmptyUserThrows() {
		SW360ClientConfig.createConfig(REST_URL, AUTH_URL, "", PASSWORD, CLIENT_ID, CLIENT_PASS, USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = NullPointerException.class)
	public void testNullPasswordThrows() {
		SW360ClientConfig.createConfig(REST_URL, AUTH_URL, USER, null, CLIENT_ID, CLIENT_PASS, USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testEmptyPasswordThrows() {
		SW360ClientConfig.createConfig(REST_URL, AUTH_URL, USER, "", CLIENT_ID, CLIENT_PASS, USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = NullPointerException.class)
	public void testNullClientThrows() {
		SW360ClientConfig.createConfig(REST_URL, AUTH_URL, USER, PASSWORD, null, CLIENT_PASS, USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testEmptyClientThrows() {
		SW360ClientConfig.createConfig(REST_URL, AUTH_URL, USER, PASSWORD, "", CLIENT_PASS, USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = NullPointerException.class)
	public void testNullClientPasswordThrows() {
		SW360ClientConfig.createConfig(REST_URL, AUTH_URL, USER, PASSWORD, CLIENT_ID, null, USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testEmptyClientPasswordThrows() {
		SW360ClientConfig.createConfig(REST_URL, AUTH_URL, USER, PASSWORD, CLIENT_ID, "", USER_TOKEN, httpClient,
				mapper);
	}

	@Test(expected = NullPointerException.class)
	public void testNullHttpClientThrows() {
		SW360ClientConfig.createConfig(REST_URL, AUTH_URL, USER, PASSWORD, CLIENT_ID, CLIENT_PASS, USER_TOKEN, null,
				mapper);
	}

	@Test(expected = NullPointerException.class)
	public void testNullObjectMapperThrows() {
		SW360ClientConfig.createConfig(REST_URL, AUTH_URL, USER, PASSWORD, CLIENT_ID, CLIENT_PASS, USER_TOKEN,
				httpClient, null);
	}

	@Test
	public void testCreateConfig() {
		SW360ClientConfig config = SW360ClientConfig.createConfig(REST_URL, AUTH_URL, USER, PASSWORD, CLIENT_ID,
	...
	public void testCreateConfigToken() {
		...
		SW360ClientConfig config = SW360ClientConfig.createConfig(REST_URL, AUTH_URL, "", "", CLIENT_ID, CLIENT_PASS,
				USER_TOKEN, httpClient, mapper);
	...
	public void testTrailingSlashesFromURLsAreRemoved() {
		SW360ClientConfig config = SW360ClientConfig.createConfig(REST_URL + "/", AUTH_URL + "/", USER, PASSWORD,
