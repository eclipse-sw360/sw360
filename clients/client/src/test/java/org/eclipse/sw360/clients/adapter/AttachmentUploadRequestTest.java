...
public class AttachmentUploadRequestTest {
	...
	public void testEquals() {
		...
		EqualsVerifier.forClass(AttachmentUploadRequest.class)
				.withPrefabValues(SW360HalResource.class, release1, release2).withNonnullFields("items").verify();
	}
	...
	public void testToString() {
		...
		AttachmentUploadRequest<SW360Release> request = AttachmentUploadRequest.builder(release)
				...
				.addAttachment(path2, SW360AttachmentType.REQUIREMENT).build();
	...
	public void testItemsListIsCopiedOnCreation() {
		...
		AttachmentUploadRequest.Builder<SW360Release> builder = AttachmentUploadRequest.builder(new SW360Release())
