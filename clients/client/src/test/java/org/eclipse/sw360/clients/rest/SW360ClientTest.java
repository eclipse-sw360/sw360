...
public class SW360ClientTest {
	...
	@Before
	public void setUp() {
		SW360ClientConfig config = SW360ClientConfig.createConfig(BASE_REST_URI, BASE_REST_URI + "/auth/token", "scott",
				"tiger", "CLIENT_ID", "CLIENT_PASSWORD", "USER_TOKEN", mock(HttpClient.class),
