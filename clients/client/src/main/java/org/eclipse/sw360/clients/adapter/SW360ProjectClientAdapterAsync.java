...
public interface SW360ProjectClientAdapterAsync {
	/**
	 * Returns the {@code SW360ProjectClient} used by this adapter. This client can
	 * be used for low-level operations on project entities.
	 *
	...
	/**
	 * Searches for a project based on its name and version. This method is more
	 * convenient for this special use case than a generic search.
	 *
	 * @param projectName
	 *            the name of the project
	 * @param projectVersion
	 *            the desired project version
	 * @return a future with an {@code Optional} with the project that was found
	 */
	CompletableFuture<Optional<SW360Project>> getProjectByNameAndVersion(String projectName, String projectVersion);

	/**
	 * Searches for projects based on the given search criteria. This method just
	 * delegates to the {@link SW360ProjectClient}.
	 *
	 * @param params
	...
	/**
	 * Creates a new {@code SW360Project} entity based on the given data object. The
	 * passed in object is validated whether it contains all mandatory properties.
	 *
	 * @param project
	 *            the data object defining the project properties
	 ...
	 *
	 * @param project
	 *            the data object with the updated properties
	 ...
	 * @param releases
	 *            a collection with the {@code SW360Release} objects to be assigned
	...
	/**
	 * Returns a list with all the release entities that are linked to the project
	 * specified.
	 *
	 * @param projectId
	 *            the ID of the project
	 * @param transitive
	 *            if <strong>true</strong>, the releases assigned to directly linked
	 *            releases are retrieved as well
	...
	/**
	 * Deletes the project with the given ID. It inspects the {@link StatusCode}
