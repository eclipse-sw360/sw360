...
public final class SW360SparseRelease extends SW360SimpleHalResource {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof SW360SparseRelease) || !super.equals(o))
			return false;
		SW360SparseRelease that = (SW360SparseRelease) o;
		return Objects.equals(componentId, that.componentId) && Objects.equals(name, that.name)
				&& Objects.equals(version, that.version) && Objects.equals(cpeid, that.cpeid)
