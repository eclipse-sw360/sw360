 ...
 * projects returned by a search. This class makes the search criteria available
 * explicit; so a search can be defined by setting the corresponding properties
 * on an instance. Instances are created using a builder class.
 * </p>
 */
public final class ProjectSearchParams {
	/**
	 * Constant for a {@code ProjectSearchParams} instance that does not define any
	 * search criteria. When using this instance, all projects that can be accessed
	 ...
	 *
	 * @return the business unit search criterion (may be <strong>null</strong>)
	 */
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(getName(), params.getName()) && getType() == params.getType()
	...
	public String toString() {
		return "ProjectSearchParams{" + "name='" + name + '\'' + ", type=" + type + ", businessUnit='" + businessUnit
				+ '\'' + ", tag='" + tag + '\'' + '}';
	}

	/**
	 * Returns a {@code Builder} object for creating new instances of this class.
	 *
	 ...
	 * </p>
	 * <p>
	 * Using this builder class, the criteria for the project search can be defined.
	 * Criteria that are not set are not taken into account for the search.
	 * </p>
	 */
	public static final class Builder {
		...
		/**
		 * Sets the search criterion for the project name. This is a contains search;
		 * all projects are matched whose name contains the string provided here.
		 *
		 * @param name
		...
		/**
		 * Sets the search criterion for the project type. Only projects with this exact
		 * type are matched.
		 *
		 * @param type
		...
		/**
		 * Sets the search criterion for the projects' business unit. Only projects
		 * assigned to this exact unit are matched.
		 *
		 * @param unit
		...
		/**
		 * Sets the search criterion for the project tag. Only projects with this exact
		 * tag are matched.
		 *
		 * @param tag
		 *            the desired tag
		...
		/**
		 * Creates a new {@code ProjectSearchParams} instance based on the properties
		 * set so far on this builder instance.
		 *
