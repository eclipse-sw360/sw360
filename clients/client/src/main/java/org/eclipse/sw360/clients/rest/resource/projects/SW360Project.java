...
public final class SW360Project extends SW360HalResource<LinkObjects, SW360ProjectEmbedded> {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof SW360Project) || !super.equals(o))
			return false;
		SW360Project that = (SW360Project) o;
		return Objects.equals(name, that.name) && Objects.equals(version, that.version)
				&& projectType == that.projectType && Objects.equals(description, that.description)
				&& Objects.equals(externalIds, that.externalIds) && Objects.equals(createdOn, that.createdOn)
				&& Objects.equals(businessUnit, that.businessUnit) && visibility == that.visibility
