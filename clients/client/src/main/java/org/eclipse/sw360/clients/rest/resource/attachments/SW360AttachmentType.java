...
public enum SW360AttachmentType {
	DOCUMENT(0), SOURCE(1), DESIGN(2), REQUIREMENT(3), CLEARING_REPORT(4), COMPONENT_LICENSE_INFO_XML(
			5), COMPONENT_LICENSE_INFO_COMBINED(6), SCAN_RESULT_REPORT(7), SCAN_RESULT_REPORT_XML(8), SOURCE_SELF(
					9), BINARY(10), BINARY_SELF(11), DECISION_REPORT(
							12), LEGAL_EVALUATION(13), LICENSE_AGREEMENT(14), SCREENSHOT(15), OTHER(16), README_OSS(17);
