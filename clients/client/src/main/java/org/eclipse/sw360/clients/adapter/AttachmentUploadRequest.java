 ...
 * 
 * @param <T>
 *            the type of the entity to upload attachments to
 */
public final class AttachmentUploadRequest<T extends SW360HalResource<?, ?>> {
	...
	/**
	 * Creates a new instance of {@code AttachmentUploadRequest} with the items to
	 * be uploaded.
	 *
	 * @param target
	 *            the target entity of the uploads
	 * @param items
	 *            a list with the items to be uploaded
	 */
	...
	/**
	 * Returns a new {@code Builder} to define a request to upload attachments to
	 * the given entity.
	 *
	 * @param target
	 *            the target of the upload operation
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(getTarget(), request.getTarget()) && items.equals(request.items);
	}
	...
	public String toString() {
		return "AttachmentUploadRequest{" + "target=" + target + ", items=" + items + '}';
	}

	/**
	 * A simple data class representing a single attachment item to be uploaded.
	 */
	public static final class Item {
		...
		@Override
		public String toString() {
			return "Item{" + "path=" + path + ", attachmentType=" + attachmentType + '}';
		}
	}
	...
	public static class Builder<T extends SW360HalResource<?, ?>> {
		 ...
		 *            the path to the document to be uploaded
		 * @param attachmentType
		 *            the type of the resulting attachment
		 * @return this builder
		 */
		...
		/**
		 * Creates the request to upload attachments based on the data added to this
		 * builder so far.
		 *
