...
public final class SW360User extends SW360SimpleHalResource {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof SW360User) || !super.equals(o))
			return false;
		SW360User sw360User = (SW360User) o;
		return Objects.equals(email, sw360User.email) && Objects.equals(type, sw360User.type)
				&& userGroup == sw360User.userGroup && Objects.equals(department, sw360User.department)
				&& Objects.equals(fullName, sw360User.fullName) && Objects.equals(givenName, sw360User.givenName)
