...
public abstract class SW360HalResource<L extends LinkObjects, E extends Embedded> {
	...
	/**
	 * Returns the ID of this element. The ID is the last part of the link to this
	 * resource. It can be used to generate a link to this resource from the
	 * resource's endpoint. Result may be <strong>null</strong> if this object is
	 * not initialized.
	 *
	...
	public boolean equals(Object o) {
		...
		return that.canEqual(this) && Objects.equals(links, that.links) && Objects.equals(embedded, that.embedded);
	}
	 ...
	 * {@code Embedded} object when no real value is available. Note: Defining this
	 * as an enum makes sure that only a single instance ever exists.
	 * </p>
	 */
