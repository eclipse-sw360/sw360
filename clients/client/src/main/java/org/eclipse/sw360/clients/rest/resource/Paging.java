...
public final class Paging {
	...
	/**
	 * Returns the current page size. This is the number of elements contained on a
	 * single result page.
	 *
	...
	/**
	 * Returns the total number of pages available. Requesting a page with an index
	 * beyond this limit causes a failure response.
	 *
	...
	public boolean equals(Object o) {
		...
		return getSize() == paging.getSize() && getNumber() == paging.getNumber()
				&& getTotalElements() == paging.getTotalElements() && getTotalPages() == paging.getTotalPages();
	}
	...
	public String toString() {
		return "Paging{" + "size=" + size + ", number=" + number + ", totalElements=" + totalElements + ", totalPages="
				+ totalPages + '}';
	}
}
