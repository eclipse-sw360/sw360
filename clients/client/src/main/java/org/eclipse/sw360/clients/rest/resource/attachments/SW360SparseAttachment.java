...
public final class SW360SparseAttachment extends SW360SimpleHalResource {
	...
	/**
	 * Returns the SHA1 hash sum of the represented attachment file. This checksum
	 * is calculated automatically by SW360.
	 *
	...
	public String getAttachmentId() {
		return Optional.ofNullable(getLinks()).map(LinkObjects::getSelf)
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(filename, that.filename) && Objects.equals(attachmentType, that.attachmentType)
