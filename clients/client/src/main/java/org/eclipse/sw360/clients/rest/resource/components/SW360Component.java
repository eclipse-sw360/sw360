...
public final class SW360Component extends SW360HalResource<LinkObjects, SW360ComponentEmbedded> {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof SW360Component) || !super.equals(o))
			return false;
		SW360Component that = (SW360Component) o;
		return Objects.equals(name, that.name) && componentType == that.componentType
				&& Objects.equals(createdOn, that.createdOn) && Objects.equals(homepage, that.homepage)
