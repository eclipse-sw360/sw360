...
class SW360ReleaseAdapterUtils {
	...
	/**
	 * Validates the given release before it is sent to the server. Checks whether
	 * all mandatory properties are set. If validation failures are detected,
	 * exceptions with corresponding messages are thrown.
	 *
	 * @param release
	 *            the release to be validated
