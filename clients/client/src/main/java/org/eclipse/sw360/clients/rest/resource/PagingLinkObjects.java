 ...
 * through the result set, e.g. to go to the next page or skip to the last one.
 * This specialized {@code LinkObjects} implementation exposes these links
 * directly via properties.
 * </p>
 */
public final class PagingLinkObjects extends LinkObjects {
	 ...
	 *
	 * @param first
	 *            the link to the first result page
	 */
	 ...
	 *
	 * @param previous
	 *            the link to the previous result page
	 */
	...
	/**
	 * Returns the link to the next result page. This may be <strong>null</strong>
	 ...
	 *
	 * @param last
	 *            the link to the last result page
	 */
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof PagingLinkObjects) || !super.equals(o))
			return false;
		PagingLinkObjects that = (PagingLinkObjects) o;
		return Objects.equals(getFirst(), that.getFirst()) && Objects.equals(getPrevious(), that.getPrevious())
				&& Objects.equals(getNext(), that.getNext()) && Objects.equals(getLast(), that.getLast());
	}
