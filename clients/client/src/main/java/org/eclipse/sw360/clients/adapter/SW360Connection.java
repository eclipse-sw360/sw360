...
/**
 * <p>
 * The central interface for obtaining client objects to interact with an SW360
 * server.
 * </p>
 * <p>
 * This interface provides access to a number of adapter objects that can deal
 * with specific SW360 endpoints. Via these adapter objects information can be
 * queried from and updated in SW360.
 * </p>
 * <p>
...
public interface SW360Connection {
	 ...
	 * <em>components</em> endpoint of SW360. Using this adapter, information about
	 * all known software components can be queried.
	 *
	 ...
	 * multiple releases. Using this adapter, the releases for the known components
