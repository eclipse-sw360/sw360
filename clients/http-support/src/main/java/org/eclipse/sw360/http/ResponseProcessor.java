 ...
 * </p>
 * <p>
 * An object implementing this interface must be passed to {@link HttpClient} in
 * order to execute a request. It is invoked when the response arrives. It has
 * full access to all response data. This information can be used to either
 * generate an arbitrary result object or fail with an appropriate exception.
 * </p>
 *
 * @param <T>
 *            the type of the result generated by this processor
 */
@FunctionalInterface
