...
class RequestBuilderImpl implements RequestBuilder {
	...
	/**
	 * A builder for constructing a multi-part request. This is used only if the
	 * {@code bodyPart()} method is invoked.
	 */
	private MultipartBody.Builder multipartBuilder;

	/**
	 * Creates a new instance of {@code RequestBuilderImpl} to build a new request.
	 *
	 * @param mapper
	...
	public Request build() {
		...
		return requestBuilder.method(httpMethod, requestBody).headers(getHeaders()).build();
	}
