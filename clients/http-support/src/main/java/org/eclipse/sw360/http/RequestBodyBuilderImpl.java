...
class RequestBodyBuilderImpl implements RequestBodyBuilder {
	...
	/**
	 * Stores the name of a file to be uploaded. This field is only defined if a
	 * body of type file has been set.
	 */
	private String fileName;

	/**
	 * Creates a new {@code RequestBodyBuilderImpl} object and initializes it with
	...
	/**
	 * Returns the request body that has been generated based on the interactions
	 * with this builder. Throws an exception if no body has been set. (We assume
	 * that it is an error in the usage of this library to request a body builder,
	 * but do not actually define a body.)
	 *
	 * @return the {@code RequestBody}
	 * @throws IllegalStateException
	 *             if the request body is undefined
	 */
	...
	/**
	 * Returns the file name for a file upload request. A file name is only defined
	 * if the {@code file()} method was called.
	 *
	...
	/**
	 * Initializes the body created by this builder. Throws an exception if a body
