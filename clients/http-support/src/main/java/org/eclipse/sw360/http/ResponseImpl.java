...
/**
 * <p>
 * An adapter class that implements the {@code Response} interface of the SW360
 * HTTP library on top of a response object from OkHttpClient.
 * </p>
 */
class ResponseImpl implements org.eclipse.sw360.http.Response {
	...
	/**
	 * Creates a new instance of {@code ResponseImpl} and initializes it with the
	 * original response to be wrapped.
	 * 
	 * @param response
	 *            the underlying response from OkHttpClient
	 */
