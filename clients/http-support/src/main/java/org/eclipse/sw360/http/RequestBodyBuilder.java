 ...
 * consumer which then invokes the desired method to set the body. Note that the
 * methods are mutually exclusive; a concrete builder instance will allow only a
 * single method call.
 * </p>
 */
public interface RequestBodyBuilder {
	...
	/**
	 * Sets the request body as an object that is serialized to JSON. This method
	 * uses an internal JSON object mapper to generate a JSON representation from
	 * the object passed in. It also automatically sets a correct
	 * {@code Content-Type} header.
	 *
	 * @param payload
	 *            the object to be used as request payload
	 */
