...
public final class HttpClientConfig {
	 ...
	 */
	private static final HttpClientConfig BASIC_CONFIG = new HttpClientConfig(null,
			ProxySettings.defaultProxySelector());

	/**
	 * Stores a custom JSON object mapper. The field is null if no custom mapper has
	 * been set.
	 */
	 ...
	 *            an optional custom JSON mapper
	 * @param proxySettings
	 *            the proxy settings
	 */
	...
	/**
	 * Returns a basic {@code HttpClientConfig} instance. This instance contains a
	 * minimum configuration. It can be used for simple use cases or serve as a
	 * starting point for constructing custom configurations.
	 *
	...
	/**
	 * Returns an {@code Optional} with a custom JSON object mapper to be used for
	 * dealing with JSON payload. If this {@code Optional} is empty, a new mapper
	 * (without a special configuration) is created and used by the HTTP client.
	 *
	...
	/**
	 * Returns an {@code ObjectMapper} instance that is either the custom mapper
	 * which has been set explicitly or a newly created instance. This method can be
	 * used to obtain a correct and non-null JSON mapper instance.
	 *
	...
	/**
	 * Returns a {@code ProxySettings} object with the proxy configuration to be
	 * used.
	 *
	...
	/**
	 * Returns a new instance of {@code HttpClientConfig} that contains the same
	 * settings as this instance, but with the JSON object mapper set to the
	 * parameter specified.
	 *
	 * @param newMapper
	 *            the JSON object mapper (can be <strong>null</strong> to remove a
	 *            special custom object mapper)
	...
	/**
	 * Returns a new instance of {@code HttpClientConfig} that contains the same
	 * settings as this instance, but with the proxy configuration set to the
	 * parameter specified.
	 *
	 * @param newProxySettings
	 *            the proxy configuration to be set
	 * @return the new {@code HttpClientConfig} instance
	 */
