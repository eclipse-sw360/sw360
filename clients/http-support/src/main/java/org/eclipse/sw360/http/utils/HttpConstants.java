...
public final class HttpConstants {
	...
	/**
	 * Constant for the HTTP status code 201 CREATED indicating that a resource has
	 * been created successfully.
	 */
	public static final int STATUS_CREATED = 201;

	/**
	 * Constant for the HTTP status code 202 ACCEPTED indicating that a request is
	 * processed asynchronously.
	 */
	public static final int STATUS_ACCEPTED = 202;

	/**
	 * Constant for the HTTP status code 204 NO_CONTENT indicating that a request
	 * has a null body.
	 */
	 ...
	 * operations affecting multiple entities. The response body typically contains
	 * more information about the single operations and their outcome.
	 */
	...
	/**
	 * Constant for the HTTP status code 404 NOT FOUND indicating that the resource
	...
	/**
	 * Constant for the HTTP header for defining the media type(s) accepted by the
	 * client.
	 */
	...
	/**
	 * Constant for the authentication scheme used for bearer tokens. This scheme is
	 * used when an OAuth 2.0 access token needs to be passed to the server.
	 */
	public static final String AUTH_BEARER = "Bearer ";

	/**
	 * Constant for the charset UTF-8. This declaration can be appended to some
	 * content types to make the charset used explicit.
	 */
