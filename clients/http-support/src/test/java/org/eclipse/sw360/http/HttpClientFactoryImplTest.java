...
public class HttpClientFactoryImplTest {
	...
	/**
	 * Creates a new client using the factory under test and checks whether it is of
	 * the expected type.
	 *
	 * @param config
	...
	public void testNewClientWithProxySettings() {
		...
		HttpClientConfig config = HttpClientConfig.basicConfig().withProxySettings(proxySettings);
