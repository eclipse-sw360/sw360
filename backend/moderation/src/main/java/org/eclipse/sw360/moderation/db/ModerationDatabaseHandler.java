...
public class ModerationDatabaseHandler {
    ...
    public void updateClearingRequestForProjectDeletion(Project project, User user) {
       try {
            ...
            if (clearingRequest == null) {
                log.info("Clearing request " + project.getClearingRequestId() + " not found for project " + project.getId() + " deletion. It may have already been deleted.");
                return;
            }
            ...
            log.error("Failed to update clearing request for project deletion. Project: " + project.getId() + ", CR-ID: " + project.getClearingRequestId() + ", User: " + user.getEmail() + ", Error: " + e.getMessage());
        }
    }
    ...
    public Map<String, Long> getCountByModerationStateAndRequestingUser(String moderator, String requestingUser) {
        return repository.getCountByModerationStateAndRequestingUser(moderator, requestingUser);
    }
