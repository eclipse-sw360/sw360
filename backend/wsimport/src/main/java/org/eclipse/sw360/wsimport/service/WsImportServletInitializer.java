...
public class WsImportServletInitializer extends AbstractBackendServletInitializer {
    private static final String SERVLET_NAME = "ProjectImportService";
    ...
    protected ServletRegistration.Dynamic getServletRegistration(
        ...
        TServlet servletInstance = rootContext.getBean("wsimportServlet", TServlet.class);
