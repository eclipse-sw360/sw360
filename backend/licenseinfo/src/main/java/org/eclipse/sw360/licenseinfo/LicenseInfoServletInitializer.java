...
public class LicenseInfoServletInitializer extends AbstractBackendServletInitializer {
    private static final String SERVLET_NAME = "LicenseInfoService";
    ...
    protected ServletRegistration.Dynamic getServletRegistration(
        ...
        TServlet servletInstance = rootContext.getBean("licenseInfoServlet", TServlet.class);
