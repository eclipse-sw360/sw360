...
public class SpdxDocumentCreationInfoSearchHandler extends BaseNouveauSearchHandler<DocumentCreationInformation> {
    ...
    public SpdxDocumentCreationInfoSearchHandler(Cloudant cClient, String dbName) throws IOException {
        super(DocumentCreationInformation.class, "documentCreationInformation", SPDX_DOC_INDEX_DEFINITION);
    ...
    public List<DocumentCreationInformation> search(String searchText) {
        ...
        Map<String, Set<String>> subQueryRestrictions = Map.of(
                DocumentCreationInformation._Fields.ID.getFieldName(), Collections.singleton(searchText)
        );
        Map<PaginationData, List<DocumentCreationInformation>> result = baseSearchWithOr(connector, subQueryRestrictions, pageData);
