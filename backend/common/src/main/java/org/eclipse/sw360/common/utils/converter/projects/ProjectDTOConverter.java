...
public final class ProjectDTOConverter {
    ...
    public static ProjectDTO fromThrift(org.eclipse.sw360.datahandler.thrift.projects.ProjectDTO thrift) {
        if (thrift == null) {
            return null;
        }
        ProjectDTO pojo = new ProjectDTO();
        ...
        if (thrift.isSetDependencyNetwork()) {
            pojo.setDependencyNetwork(ThriftCollectionConverter.mapList(thrift.getDependencyNetwork(), e -> org.eclipse.sw360.common.utils.converter.components.ReleaseNodeConverter.fromThrift(e)));
        }
    ...
    public static org.eclipse.sw360.datahandler.thrift.projects.ProjectDTO toThrift(ProjectDTO pojo) {
        if (pojo == null) {
            return null;
        }
        org.eclipse.sw360.datahandler.thrift.projects.ProjectDTO thrift = new org.eclipse.sw360.datahandler.thrift.projects.ProjectDTO();
        ...
        if (pojo.getDependencyNetwork() != null) {
            thrift.setDependencyNetwork(ThriftCollectionConverter.mapList(pojo.getDependencyNetwork(), e -> org.eclipse.sw360.common.utils.converter.components.ReleaseNodeConverter.toThrift(e)));
        }
