...
public class PackageServletInitializer extends AbstractBackendServletInitializer {
    private static final String SERVLET_NAME = "PackageService";
    ...
    protected ServletRegistration.Dynamic getServletRegistration(
        ...
        TServlet servletInstance = rootContext.getBean("packagesServlet", TServlet.class);
