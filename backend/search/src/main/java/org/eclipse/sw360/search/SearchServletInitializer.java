...
public class SearchServletInitializer extends AbstractBackendServletInitializer {
    private static final String SERVLET_NAME = "SearchService";
    ...
    protected ServletRegistration.Dynamic getServletRegistration(
        ...
        TServlet servletInstance = rootContext.getBean("searchServlet", TServlet.class);
