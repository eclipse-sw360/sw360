...
public enum SummaryType {
	SUMMARY, // Create a summary view of a document for use in the frontend summary
				// datatables
	SHORT, // Create a very short copy of a document (typically with only ID and name), in
			// particular for use in the frontend home portlets.
