...
public class ModerationHandler implements ModerationService.Iface {
	...
	public ModerationHandler() throws IOException {
		handler = new ModerationDatabaseHandler(DatabaseSettings.getConfiguredClient(),
				DatabaseSettings.COUCH_DB_DATABASE, DatabaseSettings.COUCH_DB_ATTACHMENTS);
		modSearchHandler = new ModerationSearchHandler(DatabaseSettings.getConfiguredHttpClient(),
	...
	@Override
	public RequestStatus acceptRequest(ModerationRequest request, String moderationComment, String reviewer)
			throws TException {
