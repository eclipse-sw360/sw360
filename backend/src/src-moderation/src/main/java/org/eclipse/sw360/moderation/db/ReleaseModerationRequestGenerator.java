...
public class ReleaseModerationRequestGenerator extends ModerationRequestGenerator<Release._Fields, Release> {
	...
	@Override
	public ModerationRequest setAdditionsAndDeletions(ModerationRequest request, Release updateRelease,
		...
		request = dealWithClearingInformation(request, updateRelease.getClearingInformation(),
				actualRelease.getClearingInformation());
	...
	private ModerationRequest dealWithClearingInformation(ModerationRequest request, ClearingInformation update,
			ClearingInformation actual) {
	...
	private ModerationRequest dealWithEccInformation(ModerationRequest request, EccInformation update,
			EccInformation actual) {
