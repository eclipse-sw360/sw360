 ...
 */
public class ClearingInformationModerationRequestGenerator
		extends
			ModerationRequestGenerator<ClearingInformation._Fields, ClearingInformation> {

	@Override
	public ModerationRequest setAdditionsAndDeletions(ModerationRequest request, ClearingInformation updateCI,
			ClearingInformation actualCI) {
