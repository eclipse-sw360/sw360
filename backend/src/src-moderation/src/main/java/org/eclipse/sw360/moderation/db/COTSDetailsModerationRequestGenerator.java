 ...
 */
public class COTSDetailsModerationRequestGenerator
		extends
			ModerationRequestGenerator<COTSDetails._Fields, COTSDetails> {

	@Override
	public ModerationRequest setAdditionsAndDeletions(ModerationRequest request, COTSDetails update,
			COTSDetails actual) {
