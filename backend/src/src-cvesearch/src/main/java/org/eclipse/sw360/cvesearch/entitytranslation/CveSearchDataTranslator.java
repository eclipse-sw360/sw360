...
public class CveSearchDataTranslator
		implements
			EntityTranslator<CveSearchData, CveSearchDataTranslator.VulnerabilityWithRelation> {
	...
	public VulnerabilityWithRelation apply(CveSearchData cveSearchData) {
		...
		ReleaseVulnerabilityRelation relation = new CveSearchDataToReleaseVulnerabilityRelationTranslator()
				.apply(cveSearchData);
