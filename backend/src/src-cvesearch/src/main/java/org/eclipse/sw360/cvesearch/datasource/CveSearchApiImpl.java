...
public class CveSearchApiImpl implements CveSearchApi {
	...
	private Type META_TARGET_TYPE = new TypeToken<Map<String, Object>>() {
	}.getType();
	...
	private List<String> getParsedCveSearchMetadata(String query, String key) throws IOException {
		Map<String, List<String>> rawMap = getParsedContentFor(query,
				json -> new Gson().fromJson(json, META_TARGET_TYPE));
