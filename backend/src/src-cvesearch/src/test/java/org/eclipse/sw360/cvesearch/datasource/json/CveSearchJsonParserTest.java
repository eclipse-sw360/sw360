...
public class CveSearchJsonParserTest {
	...
	// }
	// ],
	// "summary": "ZyXEL ZyWALL 10 before 3.50 allows remote attackers to cause a
	// denial of service via an ARP packet with the firewall's IP address and an
	...
	public void listSingletonList() {
		List<CveSearchData> result = cveSearchJsonParserList
				.apply(toBufferedReader("[" + SEARCH_RESULT_SINGLE_A + "]"));
