...
public class ComponentDatabaseHandlerTest {
	...
	public void setUp() throws Exception {
		...
		// Set up vendors
		vendors = new HashMap<>();
		vendors.put("V1", new Vendor().setId("V1").setShortname("Microsoft").setFullname("Microsoft Corporation")
				.setUrl("http://www.microsoft.com"));
		vendors.put("V2", new Vendor().setId("V2").setShortname("Apache").setFullname("The Apache Software Foundation")
				.setUrl("http://www.apache.org"));
		vendors.put("V3", new Vendor().setId("V3").setShortname("Oracle").setFullname("Oracle Corporation Inc")
				.setUrl("http://www.oracle.com"));

		components = new ArrayList<>();
		Component component1 = new Component().setId("C1").setName("component1").setDescription("d1")
				.setCreatedBy(email1).setMainLicenseIds(new HashSet<>(Arrays.asList("lic1")))
				.setCreatedOn("2017-07-20");
		...
		Component component2 = new Component().setId("C2").setName("component2").setDescription("d2")
				.setCreatedBy(email2).setMainLicenseIds(new HashSet<>(Arrays.asList("lic2")))
				.setCreatedOn("2017-07-21");
		...
		Component component3 = new Component().setId("C3").setName("component3").setDescription("d3")
				.setCreatedBy(email1).setMainLicenseIds(new HashSet<>(Arrays.asList("lic3")))
				.setCreatedOn("2017-07-22");
		...
		Release release2a = new Release().setId("R2A").setComponentId("C2").setName("component2").setVersion("releaseA")
				.setCreatedBy(email1).setVendorId("V3");
		releases.add(release2a);
		Release release2b = new Release().setId("R2B").setComponentId("C2").setName("component2").setVersion("releaseB")
				.setCreatedBy(email2).setVendorId("V1");
		releases.add(release2b);
		release2b.addToSubscribers(email2);
		Release release2c = new Release().setId("R2C").setComponentId("C2").setName("component2").setVersion("releaseC")
				.setCreatedBy(email1).setVendorId("V2");
		...
		// Prepare the handler
		handler = new ComponentDatabaseHandler(DatabaseSettingsTest.getConfiguredClient(), dbName, changeLogsDbName,
				attachmentsDbName, moderator, releaseModerator, projectModerator);
	}
	...
	public void testGetComponentByReleaseId() throws Exception {
		Component component = new Component().setId("Linking").setName("Linking").setDescription("d1")
				.setCreatedBy(email1);
		...
		Release release = new Release().setId("LinkingRelease").setComponentId("Linking").setName("Linking")
				.setVersion("1.0").setCreatedBy(email1).setVendorId("V1").setReleaseIdToRelationship(releaseLink);
	...
	public void testGetLinkedReleases() throws Exception {
		...
		r1A.setReleaseIdToRelationship(
				ImmutableMap.of("R1B", ReleaseRelationship.CONTAINED, "R2A", ReleaseRelationship.REFERRED));
		...
		r2B.setReleaseIdToRelationship(
				ImmutableMap.of("R1B", ReleaseRelationship.CONTAINED, "R1A", ReleaseRelationship.REFERRED));
		...
		ReleaseLink releaseLinkR1A = createReleaseLinkTo(r1A).setReleaseRelationship(ReleaseRelationship.REFERRED)
				.setNodeId("R1A").setClearingState(ClearingState.NEW_CLEARING);
	...
	private ReleaseLink createReleaseLinkTo(Release release) {
		...
		return new ReleaseLink(release.getId(), vendors.get(release.getVendorId()).getShortname(),
				componentMap.get(release.getComponentId()).getName(), release.getVersion(), printFullname(release),
	...
	public void testDontDeleteComponentWithReleaseContained() throws Exception {
		...
		component.addToCategories(category);
		Release release = new Release().setId("DelR").setComponentId("Del").setName("delete Release").setVersion("1.0")
				.setCreatedBy(email1).setVendorId("V1").setClearingState(ClearingState.NEW_CLEARING);
	...
	public void testAddReleaseUpdatesMainLicenseIds() throws Exception {
		...
		{
			Component component = new Component().setId(componentId).setName("component4").setDescription("d4")
					.setCreatedBy(email1);
			component.addToCategories(category);
			handler.addComponent(component, email1);
		}
	...
	private String addRelease(String componentId, Set<String> licenseIds) throws SW360Exception {
		Release release = new Release().setName("REL").setVersion(nextReleaseVersion + "").setMainLicenseIds(licenseIds)
	...
	public void testAddReleaseUpdatesProgrammingLanguagesOperatingSystemsAndVendorNames() throws Exception {
		...
		Release release = new Release().setName("REL").setVersion("VER").setOperatingSystems(os).setLanguages(lang)
				.setVendorId("V1");
		...
		Release release2 = new Release().setName("REL2").setVersion("VER2").setOperatingSystems(os2).setLanguages(lang2)
				.setVendorId("V2");
...

		{
			...
			assertThat(component.vendorNames,
					containsInAnyOrder(vendors.get("V1").getShortname(), vendors.get("V2").getShortname()));
		}
	...
	public void testHasChangesInEccFields() throws Exception {
		...
		original.getEccInformation().setEccStatus(ECCStatus.APPROVED).setAssessorDepartment("XYZ")
				.setAssessorContactPerson("asessor@example.com");
		assertThat(handler.hasChangesInEccFields(original, original), is(false));
		ComponentDatabaseHandler.ECC_FIELDS.forEach(f -> {
			Release changed;
			try {
			...
			assertThat("Field " + f + " did not trigger ecc change flag",
					handler.hasChangesInEccFields(changed, original), is(true));
		});

		Release changed = handler.getRelease("R1A", user1);
		changed.getEccInformation().setEccStatus(ECCStatus.APPROVED).setAssessorDepartment("XYZ")
