...
public class TestComponentClient {
	...
	public static void main(String[] args) throws TException, IOException {
		...
		//
		// System.out.println("Fetched " + components.size() + " components from license
		// service");
		// System.out.println("Fetched " + releases.size() + " releases from license
		// service");
		// System.out.println("Fetched " + recentComponents.size() + " recent components
		...
		// Component component = new ComponentHandler("http://localhost:5984",
		// "sw360db", "sw360attachments").getComponentById(referenceId, user);
