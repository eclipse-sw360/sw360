...
public class ProjectHandler implements ProjectService.Iface {
	...
	ProjectHandler() throws IOException {
		...
		searchHandler = new ProjectSearchHandler(DatabaseSettings.getConfiguredHttpClient(),
	...
	ProjectHandler(Supplier<CloudantClient> cClient, Supplier<HttpClient> hClient, String dbName,
			String changeLogsDbName, String attchmntDbName) throws IOException {
