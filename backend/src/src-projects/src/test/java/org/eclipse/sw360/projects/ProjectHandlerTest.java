...
public class ProjectHandlerTest {
	...
	public void setUp() throws Exception {
		...
		handler = new ProjectHandler(DatabaseSettingsTest.getConfiguredClient(),
				DatabaseSettingsTest.getConfiguredHttpClient(), dbName, changeLogDbName, attachmentDbName);
	}
	...
	//
	// assertEquals(3,
	// handler.getBUProjectsSummarySummary(user1.getDepartment()).size());
	// assertEquals(1,
	// handler.getBUProjectsSummarySummary(user2.getDepartment()).size());
	// assertEquals(3,
	// handler.getBUProjectsSummarySummary(user3.getDepartment()).size());
	//
	...
	public void testUpdateProject2_1() throws Exception {
		...
		ProjectDatabaseHandler handler = new ProjectDatabaseHandler(DatabaseSettingsTest.getConfiguredClient(), dbName,
				changeLogDbName, attachmentDbName, moderator,
		...
		// Mockito.verify(moderator, times(1)).updateProject(project2,
		// user1.getEmail());
