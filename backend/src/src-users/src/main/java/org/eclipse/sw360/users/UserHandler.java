...
public class UserHandler implements UserService.Iface {
	...
	public UserHandler(Supplier<CloudantClient> client, Supplier<HttpClient> httpclient, String userDbName)
			throws IOException {
	...
	public User getByEmail(String email) throws TException {
		...
		assertNotEmpty(email,
				"Invalid empty email " + stackTraceElement.getFileName() + ": " + stackTraceElement.getLineNumber());
