...
//    @Test
    public void testSVM() throws Exception {
        String urlSVMComponents = "https://svm.cert.siemens.com/portal/api/v1/public/components";
        String urlSVMActions = "https://svm.cert.siemens.com/portal/api/v1/public/actions";
        String urlSVMPriorities = "https://svm.cert.siemens.com/portal/api/v1/public/priorities";
