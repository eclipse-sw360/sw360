...
public class ScheduleServletInitializer extends AbstractBackendServletInitializer {
    private static final String SERVLET_NAME = "ScheduleService";
    ...
    protected ServletRegistration.Dynamic getServletRegistration(
        ...
        TServlet servletInstance = rootContext.getBean("scheduleServlet", TServlet.class);
